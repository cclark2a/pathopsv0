...
static void fuzz38(skiatest::Reporter* reporter, const char* filename) {
    ...
    path.close();
    testPathOpFuzz(reporter, path, pathB, kUnion_SkPathOp, filename);   // !!! was testPathOpCheck(..., true)
}
...
static void (*firstTest)(skiatest::Reporter* , const char* filename) = testRect2;
