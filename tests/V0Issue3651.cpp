...
// originally skia's PathOpsIssue3651.cpp,
...
static void issue3651_1a(TestOptions* options) {
    SkPath path = path1_a();
...
static void issue3651_1(TestOptions* options) {
    SkPath path = path1();
    SkPath pathB = path2();
...
static void issue3651_2(TestOptions* options) {
    SkPath path = path3();
    SkPath pathB = path4();
    options->testOne(path, pathB, TinyOps::unite);
}

static void issue3651_3(TestOptions* options) {
    SkPath path = path5();
    SkPath pathB = path6();
    options->testOne(path, pathB, TinyOps::unite);
}

static void issue3651_4(TestOptions* options) {
SkPath path;
...
static void issue3651_5(TestOptions* options) {
SkPath path;
...
static void issue3651_6(TestOptions* options) {
    SkPath path;
path.cubicTo(SkBits2Float(0x41c1999a), SkBits2Float(0x4380423d), SkBits2Float(0x41ca6666), SkBits2Float(0x4380789f), SkBits2Float(0x41d33333), SkBits2Float(0x43808db9));  // 24.2f, 256.517f, 25.3f, 256.942f, 26.4f, 257.107f
path.cubicTo(SkBits2Float(0x41dc0000), SkBits2Float(0x4380a2d3), SkBits2Float(0x41e4cccd), SkBits2Float(0x4380b36f), SkBits2Float(0x41ed999a), SkBits2Float(0x4380b333));  // 27.5f, 257.272f, 28.6f, 257.402f, 29.7f, 257.4f
path.lineTo(SkBits2Float(0x411e6666), SkBits2Float(0x4380b333));  // 9.9f, 257.4f
...
static void issue3651_7(TestOptions* options) {
    SkPath path;
...
void V0Issue3651(TestTrack* track) {
