...
// originally skia's PathOpsOpTest.cpp,
// optimized for speed, reduced memory, and random access
#include "TinySkiaTests.h"

static void cubicOp1d(TestOptions* options) {
    SkPath path, pathB;
    ...
    pathB.close();
    options->testOne(path, pathB, TinyOps::difference);
}

static void cubicOp2d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,2);
...
static void cubicOp3d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,1);
...
static void cubicOp5d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,1);
...
static void cubicOp6d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,1);
...
static void cubicOp7d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,1);
...
static void cubicOp8d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,1);
...
static void cubicOp9d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,1);
...
static void quadOp9d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,1);
...
static void lineOp9d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,1);
    path.lineTo(1,6);
...
static void cubicOp1i(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,1);
    ...
    pathB.close();
    options->testOne(path, pathB, TinyOps::intersect);
}

static void cubicOp10d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,1);
...
static void cubicOp11d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,1);
...
static void cubicOp12d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,1);
...
static void cubicOp13d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,1);
...
static void cubicOp14d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,1);
...
static void cubicOp15d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,1);
...
static void cubicOp16d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,2);
...
static void cubicOp17d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,2);
...
static void cubicOp18d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,1);
...
static void cubicOp19i(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,2);
...
static void cubicOp20d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,1);
...
static void cubicOp21d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,1);
...
static void cubicOp22d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,1);
...
static void cubicOp23d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,1);
...
static void cubicOp24d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,1);
...
static void testIntersect1(TestOptions* options) {
    SkPath one, two;
    one.addRect(0, 0, 6, 6, SkPathDirection::kCW);
    two.addRect(3, 3, 9, 9, SkPathDirection::kCW);
    options->testOne(one, two, TinyOps::intersect);
}

static void testUnion1(TestOptions* options) {
    SkPath one, two;
    one.addRect(0, 0, 6, 6, SkPathDirection::kCW);
    two.addRect(3, 3, 9, 9, SkPathDirection::kCW);
    options->testOne(one, two, TinyOps::unite);
}

static void testDiff1(TestOptions* options) {
    SkPath one, two;
    one.addRect(0, 0, 6, 6, SkPathDirection::kCW);
    two.addRect(3, 3, 9, 9, SkPathDirection::kCW);
    options->testOne(one, two, TinyOps::difference);
}

static void testXor1(TestOptions* options) {
    SkPath one, two;
    one.addRect(0, 0, 6, 6, SkPathDirection::kCW);
    two.addRect(3, 3, 9, 9, SkPathDirection::kCW);
    options->testOne(one, two, TinyOps::exclusiveOr);
}

static void testIntersect2(TestOptions* options) {
    SkPath one, two;
    one.addRect(0, 0, 6, 6, SkPathDirection::kCW);
...
static void testUnion2(TestOptions* options) {
    SkPath one, two;
    one.addRect(0, 0, 6, 6, SkPathDirection::kCW);
    two.addRect(0, 3, 9, 9, SkPathDirection::kCW);
    options->testOne(one, two, TinyOps::unite);
...
static void testDiff2(TestOptions* options) {
    SkPath one, two;
    one.addRect(0, 0, 6, 6, SkPathDirection::kCW);
    two.addRect(0, 3, 9, 9, SkPathDirection::kCW);
    options->testOne(one, two, TinyOps::difference);
...
static void testXor2(TestOptions* options) {
    SkPath one, two;
    one.addRect(0, 0, 6, 6, SkPathDirection::kCW);
    two.addRect(0, 3, 9, 9, SkPathDirection::kCW);
    options->testOne(one, two, TinyOps::exclusiveOr);
...
static void testOp1d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
...
static void testOp2d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.addRect(0, 0, 1, 1, SkPathDirection::kCW);
    path.addRect(0, 0, 2, 2, SkPathDirection::kCW);
...
static void testOp3d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.addRect(0, 0, 1, 1, SkPathDirection::kCW);
...
static void testOp1u(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.addRect(0, 0, 1, 1, SkPathDirection::kCW);
    ...
    pathB.addRect(0, 0, 1, 1, SkPathDirection::kCW);
    pathB.addRect(0, 0, 1, 1, SkPathDirection::kCW);
    options->testOne(path, pathB, TinyOps::unite);
}

static void testOp4d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.addRect(0, 0, 1, 1, SkPathDirection::kCW);
...
static void testOp5d(TestOptions* options) {
    SkPath path, pathB;
...
static void testOp6d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.addRect(0, 0, 1, 1, SkPathDirection::kCW);
    path.addRect(0, 0, 3, 3, SkPathDirection::kCW);
...
static void testOp7d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.addRect(0, 0, 2, 2, SkPathDirection::kCW);
    path.addRect(0, 0, 1, 1, SkPathDirection::kCW);
...
static void testOp2u(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.addRect(0, 0, 2, 2, SkPathDirection::kCW);
    path.addRect(0, 0, 2, 2, SkPathDirection::kCW);
...
static void testOp8d(TestOptions* options) {
    SkPath path, pathB;
...
static void cubicOp25i(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,1);
...
static void cubicOp26d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,1);
...
static void cubicOp27d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,1);
...
static void cubicOp28u(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,1);
...
static void cubicOp29d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,1);
...
static void cubicOp30d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,1);
...
static void cubicOp31d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,2);
...
static void cubicOp31u(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,2);
    path.cubicTo(0,3, 2,1, 4,0);
...
static void cubicOp31x(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,2);
    path.cubicTo(0,3, 2,1, 4,0);
    ...
    pathB.cubicTo(0,4, 2,0, 3,0);
    pathB.close();
    options->testOne(path, pathB, TinyOps::exclusiveOr);
}

static void cubicOp32d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,1);
...
static void cubicOp33i(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,1);
    path.cubicTo(1,2, 6,0, 3,1);
...
static void cubicOp34d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,1);
...
static void cubicOp35d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,1);
...
static void cubicOp36u(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,1);
...
static void cubicOp37d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,1);
...
static void cubicOp38d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,1);
...
static void cubicOp39d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,1);
...
static void cubicOp40d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,1);
...
static void cubicOp41i(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,1);
...
static void cubicOp42d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,1);
...
static void cubicOp43d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,2);
...
static void cubicOp44d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,2);
...
static void cubicOp45d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,2);
...
static void cubicOp46d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,2);
...
static void cubicOp47d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,1);
...
static void cubicOp48d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,2);
...
static void cubicOp49d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,2);
...
static void cubicOp50d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,3);
...
static void cubicOp51d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,3);
...
static void cubicOp52d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,2);
...
static void cubicOp53d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,3);
...
static void cubicOp54d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,4);
...
static void cubicOp55d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,5);
...
static void cubicOp56d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,1);
...
static void cubicOp57d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,5);
...
static void cubicOp58d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,5);
...
static void cubicOp59d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,1);
...
static void cubicOp60d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,2);
...
static void cubicOp61d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(1,2);
...
static void cubicOp62d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(1,3);
...
static void cubicOp63d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(2,3);
...
static void cubicOp64d(TestOptions* options) {
    SkPath path, pathB;
    path.moveTo(0,1);
...
static void cubicOp65d(TestOptions* options) {
    SkPath path, pathB;
    path.moveTo(0,1);
...
static void rectOp1d(TestOptions* options) {
    SkPath path, pathB;
    path.moveTo(0,1);
    path.cubicTo(0,1, 1,0, 3,0);
    path.lineTo(0,1);
...
static void cubicOp66u(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,1);
...
static void cubicOp67u(TestOptions* options) {
    SkPath path, pathB;
    path.moveTo(3,5);
...
static void cubicOp68u(TestOptions* options) {
    SkPath path, pathB;
    path.moveTo(0,5);
...
static void cubicOp69d(TestOptions* options) {
    SkPath path, pathB;
    path.moveTo(1,3);
...
TinyOps tinyOps[] = {
    TinyOps::unite,
    TinyOps::exclusiveOr,
    TinyOps::reverseDifference,
    TinyOps::exclusiveOr,
    TinyOps::reverseDifference,
};

static void rRect1(TestOptions* options) {
    SkScalar xA = 0.65f;
    SkScalar xB = 10.65f;
    SkScalar xC = 20.65f;
    SkScalar xD = 30.65f;
...
static void skp1(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.moveTo(189,7);
...
static void skp2(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
...
static void skp3(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
...
static void skp4(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
...
static void skp5(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
...
static void cubicOp70d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,1);
...
static void cubicOp71d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,1);
...
static void cubicOp72i(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,1);
...
static void cubicOp73d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,1);
...
static void cubicOp74d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,1);
...
static void cubicOp75d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,1);
...
static void cubicOp76u(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,1);
...
static void cubicOp77i(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.moveTo(0,1);
...
static void cubicOp78u(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.moveTo(1,6);
...
static void cubicOp79u(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,1);
...
static void cubicOp80i(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,1);
...
static void cubicOp81d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,1);
...
static void cubicOp82i(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.moveTo(0,1);
...
static void cubicOp83i(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,1);
...
static void cubicOp84d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,4);
...
static void skpClip1(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
...
static void skpClip2(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
...
static void skp96prezzi1(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
...
static void skpancestry_com1(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
...
static void skpeldorado_com_ua1(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
...
static void skpbyte_com1(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
...
static void skphealth_com76(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
...
static void skpahrefs_com88(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
...
static void skpahrefs_com29(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
...
static void cubicOp85d(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,1);
...
static void skpkkiste_to98(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.moveTo(96, 122);
...
static void issue1417(TestOptions* options) {
    SkPath path1;
...
static void issue1418(TestOptions* options) {
    SkPath path1;
    path1.moveTo(0, 0);
    path1.lineTo(1, 0);
    path1.lineTo(1, 0);
    ...
    options->testOne(path1, path2, TinyOps::intersect);
}

static void cubicOp85i(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(3, 4);
...
static void issue1418b(TestOptions* options) {
    SkPath path1;
    path1.moveTo(0, 0);
    path1.lineTo(1, 0);
    path1.lineTo(1, 1);
...
static void rectOp1i(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.addRect(0, 0, 1, 1, SkPathDirection::kCW);
    path.addRect(2, 2, 4, 4, SkPathDirection::kCW);
...
static void rectOp2i(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.addRect(0, 0, 1, 1, SkPathDirection::kCW);
    path.addRect(0, 0, 3, 3, SkPathDirection::kCW);
...
static void rectOp3x(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.moveTo(0, 0);
    path.lineTo(3, 0);
...
static void issue1435(TestOptions* options) {
    SkPath path1;
    path1.moveTo(160, 60);
...
static void skpkkiste_to716(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
...
static void loopEdge1(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.moveTo(0,0);
    path.lineTo(3,0);
...
static void loopEdge2(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.moveTo(0,0);
    path.lineTo(3,0);
...
static void cubicOp86i(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0, 4);
...
static void cubicOp87u(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,1);
...
static void cubicOp88u(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,1);
...
static void cubicOp89u(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0, 3);
...
static void cubicOp90u(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.moveTo(0, 5);
...
static void cubicOp91u(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(1, 6);
...
static void skpaaalgarve_org53(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
...
static void skpabcspark_ca103(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
...
static void skpacesoftech_com47(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
...
static void skpact_com43(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
...
static void skpadbox_lt8(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
...
static void skpadindex_de4(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.moveTo(0, 926);
    path.lineTo(0, 0);
...
static void skpadithya_putr4_blogspot_com551(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
...
static void skpadspert_de11(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
...
static void skpaiaigames_com870(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
...
static void cubicOp92i(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0, 1);
...
static void cubicOp93d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0, 1);
...
static void cubicOp94u(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.moveTo(0, 3);
...
static void skpadbox_lt15(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
...
static void skpadoption_org196(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.moveTo(802, 367);
    path.lineTo(802, 324);
...
static void skpadspert_net23(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
...
static void skpadventistmission_org572(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
...
static void skpagentxsites_com55(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.moveTo(925, 27);
...
static void skpbakosoft_com10(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.moveTo(190, 170);
...
static void skpbambootheme_com12(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
...
static void skpakmmos_ru100(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
...
static void skpcarpetplanet_ru22(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.moveTo(195, 785);
...
static void skpcarrot_is24(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.moveTo(945, 597);
...
static void skpbangalorenest_com4(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.moveTo(0, 926);
    path.lineTo(0, 0);
...
static void skpbenzoteh_ru152(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.moveTo(883, 23);
    path.lineTo(883, 0);
...
static void skpbestred_ru37(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.moveTo(883, 23);
    path.lineTo(883, 0);
...
static void skpbingoentertainment_net189(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
...
static void skpcarrefour_ro62(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
...
static void skpcaffelavazzait_com_ua21(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.moveTo(883, 23);
    path.lineTo(883, 0);
...
static void skpcamcorder_kz21(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.moveTo(883, 23);
    path.lineTo(883, 0);
...
static void skpcavablar_net563(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
...
static void skpinsomnia_gr72(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
...
static void cubicOp95u(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.moveTo(0, 2);
    path.cubicTo(2, 3, 5, 1, 3, 2);
...
static void cubicOp96d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.moveTo(1, 6);
    path.cubicTo(0, 3, 6, 3, 5, 0);
...
static void cubicOp97x(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.moveTo(0, 2);
...
static void cubicOp98x(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.moveTo(0, 3);
...
static void cubicOp99(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(3,6);
...
static void cubicOp100(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,1);
...
static void cubicOp101(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0, 1);
...
static void cubicOp102(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,1);
...
static void cubicOp103(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,1);
...
static void cubicOp104(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,1);
...
static void cubicOp105(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,1);
...
static void cubicOp106(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0, 1);
...
static void cubicOp107(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0, 1);
    path.cubicTo(4, 6, 2, 1, 2, 0);
...
static void cubicOp108(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0, 1);
    path.cubicTo(4, 6, 2, 1, 2, 0);
...
static void cubicOp109(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,1);
...
static void cubicOp110(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.addRect(0, 0, 1, 1, SkPathDirection::kCW);
...
static void cubicOp111(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(1,4);
...
static void xOp1u(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.moveTo(1, 4);
...
static void xOp1i(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.moveTo(1, 4);
...
static void xOp2i(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.moveTo(1, 5);
...
static void xOp3i(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(1,4);
    path.cubicTo(0,5, 4,1, 3,1);
...
static void findFirst1(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,1);
...
static void cubicOp112(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(2,4);
...
static void cubicOp113(TestOptions* options) {
    SkPath path, pathB;
    path.moveTo(2,4);
...
static void cubicOp114(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0, 1);
...
void cubicOp114asQuad(TestOptions* options) {
	SkPath qPath, qPathB;
	...
	qPathB.close();
    options->testOne(qPath, qPathB, TinyOps::intersect);
}


static void quadOp10i(TestOptions* options) {
    SkPath path, pathB;
    path.moveTo(0, 0);
    path.quadTo(1, 8, 3, 5);
    path.lineTo(8, 1);
...
static void kari1(TestOptions* options) {
    SkPath path1;
    ...
    options->testOne(path1, path2, TinyOps::difference);
}

static void issue2504(TestOptions* options) {
    SkPath path1;
...
static void issue2540(TestOptions* options) {
    SkPath path1;
...
static void rects1(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.moveTo(0, 0);
    path.lineTo(1, 0);
...
static void rects2(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.moveTo(0, 0);
    path.lineTo(4, 0);
...
static void rects3(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.addRect(0, 0, 1, 1, SkPathDirection::kCW);
    path.addRect(0, 0, 4, 4, SkPathDirection::kCW);
...
static void rects4(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.addRect(0, 0, 1, 1, SkPathDirection::kCW);
    path.addRect(0, 0, 2, 2, SkPathDirection::kCW);
...
static void issue2753(TestOptions* options) {
    SkPath path1;
...
static void issue2808(TestOptions* options) {
    SkPath path1, path2;
...
static void cubicOp115(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,1);
...
static void testRect1(TestOptions* options) {
    SkPath path, path2;
...
//    path.addRect(32, 24, 36, 41, SkPathDirection::kCCW);
    options->testOne(path, path2, TinyOps::unite);
}

static void testRect2(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.addRect(0, 0, 1, 1, SkPathDirection::kCW);
...
static void cubicOp116(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,1);
...
static void cubicOp117(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,1);
...
static void cubicOp118(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,1);
...
static void loop1(TestOptions* options) {
    SkPath path, pathB;
    path.moveTo(0,1);
...
static void loop1asQuad(TestOptions* options) {
SkPath path;
path.setFillType(SkPathFillType::kWinding);
...
path.close();
SkPath b = path;
    options->testOne(a, b, TinyOps::intersect);
}

static void loop2(TestOptions* options) {
    SkPath path, pathB;
    path.moveTo(0,1);
...
static void loop3(TestOptions* options) {
    SkPath path, pathB;
    path.moveTo(0,1);
...
static void loop4(TestOptions* options) {
    SkPath path, pathB;
    path.moveTo(0,5);
...
static void issue3517(TestOptions* options) {
    SkPath path, pathB;
...
static void cubicOp119(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,1);
    path.cubicTo(3,5, 2,1, 3,1);
...
static void cubicOp120(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,1);
...
static void cubicOp121(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,1);
...
static void cubicOp122(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,1);
...
static void cubicOp123(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,1);
...
static void loop5(TestOptions* options) {
    SkPath path, pathB;
    path.moveTo(0,2);
...
static void loop6(TestOptions* options) {
    SkPath path, pathB;
    path.moveTo(0,1);
...
static void cubicOp124(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,1);
...
static void cubicOp125(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,1);
...
static void cubicOp126(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,1);
...
static void cubicOp127(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,1);
    path.cubicTo(1,5, 6,0, 3,0);
...
static void cubicOp128(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,1);
...
static void cubicOp129(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(5,6);
...
static void cubicOp130(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(5,6);
...
static void cubicOp130a(TestOptions* options) {
SkPath path;
path.setFillType(SkPathFillType::kWinding);
...
path.close();
SkPath b = path;
    options->testOne(a, b, TinyOps::difference);
}

static void cubicOp131(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,1);
...
static void circlesOp1(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
...
static void circlesOp2(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
...
static void rRect1x(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kEvenOdd);
...
static void loop7(TestOptions* options) {
    SkPath path, pathB;
    path.moveTo(0,1);
...
static void rects5(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
...
static void loop8(TestOptions* options) {
    SkPath path, pathB;
    path.moveTo(0,1);
...
static void loop9(TestOptions* options) {
    SkPath path, pathB;
    path.moveTo(0,1);
...
static void circlesOp3(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.addCircle(0, 1, 2, SkPathDirection::kCCW);
    pathB.setFillType(SkPathFillType::kWinding);
...
static void loop10(TestOptions* options) {
    SkPath path, pathB;
    path.moveTo(5,6);
...
static void loop11(TestOptions* options) {
    SkPath path, pathB;
    path.moveTo(0,1);
...
static void cubicOp132(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(5,6);
...
static void loop12(TestOptions* options) {
    SkPath path, pathB;
    path.moveTo(1,2);
...
static void cubicOp133(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(5,6);
...
static void cubicOp134(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(5,6);
...
static void cubicOp135(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(5,6);
...
static void cubicOp136(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(5,6);
...
static void cubicOp136a(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(5,6);
    path.quadTo(5,0, 3,1);
...
static void cubics137(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0, 5);
...
static void cubics138(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0, 5);
...
static void cubicOp139(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,2);
...
static void cubicOp140(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,2);
...
static void cubicOp141(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,2);
...
static void quadRect1(TestOptions* options) {
    SkPath path, pathB;
    path.moveTo(6,15);
...
static void quadRect2(TestOptions* options) {
    SkPath path, pathB;
    path.moveTo(5,12);
...
static void quadRect3(TestOptions* options) {
    SkPath path, pathB;
    path.moveTo(12,12);
    path.quadTo(2,7, 8,4);
...
static void quadRect4(TestOptions* options) {
    SkPath path, pathB;
    path.moveTo(11,15);
    path.quadTo(1,0, 9,4);
...
static void quadRect5(TestOptions* options) {
    SkPath path, pathB;
    path.moveTo(11,13);
    path.quadTo(4,4, 8,4);
...
static void quadRect6(TestOptions* options) {
    SkPath path, pathB;
    path.moveTo(5,13);
...
static void loops4i(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0, 3);
...
static void loops5i(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(1, 2);
...
static void cubicOp142(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(5,6);
...
static void cubics6d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(3, 5);
...
static void cubics7d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(2, 6);
...
static void cubics8d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(2, 5);
...
static void cubics9d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(2, 4);
...
static void cubics10u(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(2, 4);
...
static void cubics11i(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(2, 4);
...
static void cubics12d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(2, 4);
...
static void cubics13d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(2, 3);
...
static void cubics14d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(2, 3);
...
static void cubics15d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(1, 5);
...
static void cubics16i(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(1, 5);
...
static void cubics17d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(1, 5);
...
static void cubics18d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(1, 5);
...
static void cubics19d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(1, 5);
...
static void cubicOp157(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(1,5);
...
static void cubics20d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(1, 2);
...
static void loops20i(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(1, 2);
...
static void loops21i(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(1, 2);
...
static void loops22i(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(1, 3);
...
static void loops23i(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(1, 5);
...
static void loops24i(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(1, 2);
...
static void loops25i(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(1, 5);
...
static void loops26i(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(1, 6);
...
static void loops27i(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(1, 3);
...
static void loops28i(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(2, 3);
...
static void loops29i(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(2, 4);
...
static void loops30i(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(2, 4);
...
static void loops31i(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(2, 5);
...
static void loops32i(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(2, 6);
...
static void loops33i(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(2, 6);
...
static void loops33iMod(TestOptions* options) {
...
static void loops33iAsQuads(TestOptions* options) {
	SkPath qPath, qPathB;
	qPath.setFillType(SkPathFillType::kWinding);
...
static void loops34i(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(3, 4);
...
static void loops35i(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(3, 4);
...
static void loops36i(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(3, 4);
...
static void loops37i(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(2, 4);
...
static void loops38i(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(3, 4);
...
static void loops39i(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(3, 5);
...
static void loops40i(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(3, 5);
...
static void loops40iAsQuads(TestOptions* options) {
	SkPath qPath, qPathB;
	qPath.setFillType(SkPathFillType::kWinding);
...
static void loops44i(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(1, 5);
...
static void loops45i(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(1, 6);
...
static void loops46i(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(2, 6);
...
static void loops47i(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(2, 4);
...
static void loops48i(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(2, 6);
...
static void loops49i(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0, 2);
...
static void loops50i(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0, 3);
...
static void loops51i(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(1, 2);
...
static void loops52i(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(1, 3);
...
static void loops53i(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(2, 3);
...
static void loops54i(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0, 2);
...
static void loops55i(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0, 3);
...
static void loops56i(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(1, 2);
...
static void loops57i(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(1, 3);
...
static void loops58i(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(2, 3);
...
static void loops58iAsQuads(TestOptions* options) {
	SkPath qPath, qPathB;
	qPath.setFillType(SkPathFillType::kWinding);
...
static void loops59i(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0, 6);
...
static void loops59iasQuads(TestOptions* options) {
	SkPath qPath, qPathB;
	qPath.setFillType(SkPathFillType::kWinding);
...
static void cubics41d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0, 1);
...
void loops61i(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0, 1);
...
static void loops62i(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0, 2);
...
static void loops63i(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0, 1);
...
static void cubics44d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(3, 4);
...
static void cubics45u(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(1, 3);
...
static void fuzz38(TestOptions* options) {
    SkPath path, pathB;
...
static void crbug_526025(TestOptions* options) {
    SkPath path;
...
path.close();
    ...
    SkPath path2(path);
    options->ignoreRaster = true;
    options->testOne(path1, path2, (TinyOps) 2);
}

static void fuzzX_392(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
...
static void dean2(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 0);
...
static void cubics_d(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0, 1);
...
static void cubics_d2(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0, 1);
...
static void loops_i1(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(2, 3);
...
static void loops_i2(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(2, 4);
...
static void loops_i3(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(2, 5);
...
static void loops_i4(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(3, 4);
...
static void loops_i5(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(3, 5);
...
static void loops_i6(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(4, 5);
...
static void cubics_d3(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(3, 4);
...
static void cubics_o(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(1, 4);
...
static void cubicOp158(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0,1);
...
static void loop17(TestOptions* options) {
    SkPath path, pathB;
    path.moveTo(1, 2);
...
static void circlesOp4(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
...
static void bug5240(TestOptions* options) {
 SkPath path;
path.moveTo(815, 82);
...
path.close();
    options->testOne(path, path, TinyOps::unite);
}

static void android1(TestOptions* options) {
 SkPath path, pathB;
...
static void seanbug(TestOptions* options) {
   SkPath path;
   path.setFillType(SkPathFillType::kEvenOdd);
...
static void halbug(TestOptions* options) {
    SkPath path, path2;
    path.setFillType(SkPathFillType::kEvenOdd);
...
static void testRect1_u(TestOptions* options) {
    SkPath path, pathB;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0, 0);
    path.lineTo(0, 60);
...
static void filinmangust14(TestOptions* options) {
SkPath path, path1;
path.setFillType(SkPathFillType::kWinding);
...
path.reset();
        ...
        path.lineTo(SkBits2Float(0x4554b65d), SkBits2Float(0x443e0000));  // 3403.4f, 760
        path.close();
            options->testOne(path1, path, TinyOps::unite);
}

static void grshapearcs1(TestOptions* options) {
SkPath path, path1;
path.setFillType(SkPathFillType::kWinding);
...
path.conicTo(24.0412f, 27.3672f, 24.0237f, 26.3673f, 0.707107f);
path.close();
    options->testOne(path, path1, TinyOps::exclusiveOr);
}

static void op_1(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 0);
path.setFillType(SkPathFillType::kWinding);
...
static void op_2(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 1);
path.setFillType(SkPathFillType::kEvenOdd);
...
path.lineTo(SkBits2Float(0x1b1b1b00), SkBits2Float(0x1b5a5a1b));  // 1.283e-22f, 1.80617e-22f
    ...
    SkPath path2(path);
    options->testOne(path1, path2, (TinyOps) 0);
}


static void op_3(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 1);
path.setFillType(SkPathFillType::kEvenOdd);
...
static void op_4(TestOptions* options) {
   SkPath patha, pathb;
   ...
   pathb.close();
    options->testOne(patha, pathb, TinyOps::difference);
}

static void bug8228(TestOptions* options) {
    SkPath path1;
...
static void bug8380(TestOptions* options) {
SkPath path, path2;
path.setFillType(SkPathFillType::kEvenOdd);
...
void V0Op(TestTrack* track) {
    ...
    static std::vector<TestFunc> tests = {
        TEST_FUNC(bug8380),
        TEST_FUNC(crbug_526025),
        TEST_FUNC(bug8228),
        TEST_FUNC(op_4),
        TEST_FUNC(op_1),
        TEST_FUNC(op_2),
        TEST_FUNC(op_3),
        TEST_FUNC(grshapearcs1),
        TEST_FUNC(filinmangust14),
        TEST_FUNC(testRect1_u),
        TEST_FUNC(halbug),
        TEST_FUNC(seanbug),
        TEST_FUNC(android1),
        TEST_FUNC(bug5240),
        TEST_FUNC(circlesOp4),
        TEST_FUNC(loop17),
        TEST_FUNC(cubicOp158),
        TEST_FUNC(loops_i1),
        TEST_FUNC(loops_i2),
        TEST_FUNC(loops_i3),
        TEST_FUNC(loops_i4),
        ...
        TEST_FUNC(loops62i),
        TEST_FUNC(loops63i),
        TEST_FUNC(loops58iAsQuads),
        TEST_FUNC(cubics41d),
        TEST_FUNC(loops59iasQuads),
        TEST_FUNC(loops59i),
        TEST_FUNC(loops44i),
        TEST_FUNC(loops45i),
        TEST_FUNC(loops46i),
        ...
        TEST_FUNC(loops57i),
        TEST_FUNC(loops58i),
        TEST_FUNC(loops33iMod),
        TEST_FUNC(loops33iAsQuads),
        TEST_FUNC(loops33i),
        TEST_FUNC(loops40i),
        TEST_FUNC(loops40iAsQuads),
        TEST_FUNC(loops39i),
        TEST_FUNC(loops38i),
        TEST_FUNC(loops37i),
        TEST_FUNC(loops36i),
        ...
        TEST_FUNC(cubics18d),
        TEST_FUNC(cubics19d),
        TEST_FUNC(cubicOp157),
        TEST_FUNC(cubicOp142),
        TEST_FUNC(loops4i),
        TEST_FUNC(quadRect1),
        TEST_FUNC(quadRect2),
        TEST_FUNC(quadRect3),
        ...
        TEST_FUNC(quadRect5),
        TEST_FUNC(quadRect6),
        TEST_FUNC(cubicOp141),
        TEST_FUNC(cubicOp58d),
        TEST_FUNC(loops5i),
        TEST_FUNC(cubicOp140),
        TEST_FUNC(cubicOp139),
        TEST_FUNC(cubics138),
        TEST_FUNC(cubics137),
        TEST_FUNC(cubicOp136a),
        TEST_FUNC(cubicOp136),
        TEST_FUNC(cubicOp135),
        TEST_FUNC(cubicOp134),
        TEST_FUNC(cubicOp133),
        TEST_FUNC(loop12),
        TEST_FUNC(cubicOp132),
        TEST_FUNC(loop11),
        TEST_FUNC(loop10),
        TEST_FUNC(circlesOp3),
        TEST_FUNC(loop9),
        TEST_FUNC(loop8),
        TEST_FUNC(rects5),
        TEST_FUNC(loop7),
        TEST_FUNC(cubicOp130a),
        TEST_FUNC(rRect1x),
        TEST_FUNC(circlesOp2),
        TEST_FUNC(circlesOp1),
        TEST_FUNC(cubicOp131),
        TEST_FUNC(cubicOp130),
        TEST_FUNC(cubicOp129),
        TEST_FUNC(cubicOp128),
        TEST_FUNC(cubicOp127),
        TEST_FUNC(cubicOp126),
        TEST_FUNC(cubicOp125),
        TEST_FUNC(cubicOp124),
        TEST_FUNC(loop6),
        TEST_FUNC(loop5),
        TEST_FUNC(cubicOp123),
        TEST_FUNC(cubicOp122),
        TEST_FUNC(cubicOp121),
        TEST_FUNC(cubicOp120),
        TEST_FUNC(cubicOp119),
        TEST_FUNC(loop4),
        TEST_FUNC(loop3),
        TEST_FUNC(loop2),
        TEST_FUNC(loop1asQuad),
        TEST_FUNC(loop1),
        TEST_FUNC(issue3517),
        TEST_FUNC(cubicOp118),
        TEST_FUNC(cubicOp117),
        TEST_FUNC(cubicOp116),
        TEST_FUNC(testRect2),
        TEST_FUNC(testRect1),
        TEST_FUNC(cubicOp115),
        TEST_FUNC(issue2753),
        TEST_FUNC(cubicOp114),
        TEST_FUNC(issue2808),
        TEST_FUNC(cubicOp114asQuad),
        TEST_FUNC(rects4),
        TEST_FUNC(rects3),
        TEST_FUNC(rects2),
        TEST_FUNC(rects1),
        ...
        TEST_FUNC(kari1),
        TEST_FUNC(quadOp10i),
        TEST_FUNC(cubicOp113),
        TEST_FUNC(skpcarrot_is24),
        TEST_FUNC(issue1417),
        TEST_FUNC(cubicOp112),
        TEST_FUNC(skpadspert_net23),
        TEST_FUNC(skpadspert_de11),
        TEST_FUNC(findFirst1),
        TEST_FUNC(xOp2i),
        TEST_FUNC(xOp3i),
        TEST_FUNC(xOp1u),
        TEST_FUNC(xOp1i),
        TEST_FUNC(cubicOp111),
        TEST_FUNC(cubicOp110),
        TEST_FUNC(cubicOp109),
        TEST_FUNC(cubicOp108),
        TEST_FUNC(cubicOp107),
        TEST_FUNC(cubicOp106),
        TEST_FUNC(cubicOp105),
        TEST_FUNC(cubicOp104),
        TEST_FUNC(cubicOp103),
        TEST_FUNC(cubicOp102),
        TEST_FUNC(cubicOp101),
        TEST_FUNC(cubicOp100),
        TEST_FUNC(cubicOp99),
        TEST_FUNC(issue1435),
        TEST_FUNC(cubicOp98x),
        TEST_FUNC(cubicOp97x),
        TEST_FUNC(skpcarpetplanet_ru22),
        TEST_FUNC(cubicOp96d),
        TEST_FUNC(cubicOp95u),
        TEST_FUNC(skpadbox_lt15),
        TEST_FUNC(skpagentxsites_com55),
        TEST_FUNC(skpadventistmission_org572),
        TEST_FUNC(skpadoption_org196),
        TEST_FUNC(skpbambootheme_com12),
        TEST_FUNC(skpbakosoft_com10),
        TEST_FUNC(skpakmmos_ru100),
        TEST_FUNC(skpbangalorenest_com4),
        TEST_FUNC(skpbingoentertainment_net189),
        TEST_FUNC(skpbestred_ru37),
        TEST_FUNC(skpbenzoteh_ru152),
        TEST_FUNC(skpcamcorder_kz21),
        TEST_FUNC(skpcaffelavazzait_com_ua21),
        TEST_FUNC(skpcarrefour_ro62),
        TEST_FUNC(skpcavablar_net563),
        TEST_FUNC(skpinsomnia_gr72),
        TEST_FUNC(skpadbox_lt8),
        TEST_FUNC(skpact_com43),
        TEST_FUNC(skpacesoftech_com47),
        TEST_FUNC(skpabcspark_ca103),
        TEST_FUNC(cubicOp94u),
        TEST_FUNC(cubicOp93d),
        TEST_FUNC(cubicOp92i),
        TEST_FUNC(skpadithya_putr4_blogspot_com551),
        TEST_FUNC(skpadindex_de4),
        TEST_FUNC(skpaiaigames_com870),
        TEST_FUNC(skpaaalgarve_org53),
        TEST_FUNC(skpkkiste_to716),
        TEST_FUNC(cubicOp91u),
        TEST_FUNC(cubicOp90u),
        TEST_FUNC(cubicOp89u),
        TEST_FUNC(cubicOp88u),
        TEST_FUNC(cubicOp87u),
        TEST_FUNC(cubicOp86i),
        TEST_FUNC(loopEdge2),
        TEST_FUNC(loopEdge1),
        TEST_FUNC(rectOp3x),
        TEST_FUNC(rectOp2i),
        TEST_FUNC(rectOp1i),
        TEST_FUNC(issue1418b),
        TEST_FUNC(cubicOp85i),
        TEST_FUNC(issue1418),
        TEST_FUNC(skpkkiste_to98),
        TEST_FUNC(skpahrefs_com29),
        TEST_FUNC(cubicOp85d),
        TEST_FUNC(skpahrefs_com88),
        TEST_FUNC(skphealth_com76),
        TEST_FUNC(skpancestry_com1),
        TEST_FUNC(skpbyte_com1),
        TEST_FUNC(skpeldorado_com_ua1),
        TEST_FUNC(skp96prezzi1),
        TEST_FUNC(skpClip2),
        TEST_FUNC(skpClip1),
        TEST_FUNC(cubicOp84d),
        TEST_FUNC(cubicOp83i),
        TEST_FUNC(cubicOp82i),
        TEST_FUNC(cubicOp81d),
        TEST_FUNC(cubicOp80i),
        TEST_FUNC(cubicOp79u),
        TEST_FUNC(cubicOp78u),
        TEST_FUNC(cubicOp77i),
        TEST_FUNC(cubicOp76u),
        TEST_FUNC(cubicOp75d),
        TEST_FUNC(cubicOp74d),
        TEST_FUNC(cubicOp73d),
        TEST_FUNC(cubicOp72i),
        TEST_FUNC(cubicOp71d),
        TEST_FUNC(skp5),
        TEST_FUNC(skp4),
        TEST_FUNC(skp3),
        TEST_FUNC(skp2),
        ...
        TEST_FUNC(cubicOp67u),
        TEST_FUNC(cubicOp66u),
        TEST_FUNC(rectOp1d),
        TEST_FUNC(cubicOp65d),
        TEST_FUNC(cubicOp64d),
        TEST_FUNC(cubicOp63d),
        TEST_FUNC(cubicOp62d),
        TEST_FUNC(cubicOp61d),
        TEST_FUNC(cubicOp60d),
        TEST_FUNC(cubicOp59d),
        TEST_FUNC(cubicOp57d),
        TEST_FUNC(cubicOp56d),
        TEST_FUNC(cubicOp55d),
        TEST_FUNC(cubicOp54d),
        TEST_FUNC(cubicOp53d),
        TEST_FUNC(cubicOp52d),
        TEST_FUNC(cubicOp51d),
        TEST_FUNC(cubicOp50d),
        TEST_FUNC(cubicOp49d),
        TEST_FUNC(cubicOp48d),
        TEST_FUNC(cubicOp47d),
        TEST_FUNC(cubicOp46d),
        TEST_FUNC(cubicOp45d),
        TEST_FUNC(cubicOp44d),
        TEST_FUNC(cubicOp43d),
        TEST_FUNC(cubicOp42d),
        TEST_FUNC(cubicOp41i),
        TEST_FUNC(cubicOp40d),
        TEST_FUNC(cubicOp39d),
        TEST_FUNC(cubicOp38d),
        TEST_FUNC(cubicOp37d),
        TEST_FUNC(cubicOp36u),
        TEST_FUNC(cubicOp35d),
        TEST_FUNC(cubicOp34d),
        TEST_FUNC(cubicOp33i),
        TEST_FUNC(cubicOp32d),
        TEST_FUNC(cubicOp31d),
        TEST_FUNC(cubicOp31x),
        TEST_FUNC(cubicOp31u),
        TEST_FUNC(cubicOp30d),
        TEST_FUNC(cubicOp29d),
        TEST_FUNC(cubicOp28u),
        TEST_FUNC(cubicOp27d),
        TEST_FUNC(cubicOp26d),
        TEST_FUNC(cubicOp25i),
        TEST_FUNC(testOp8d),
        TEST_FUNC(testDiff1),
        TEST_FUNC(testIntersect1),
        TEST_FUNC(testUnion1),
        TEST_FUNC(testXor1),
        TEST_FUNC(testDiff2),
        TEST_FUNC(testIntersect2),
        TEST_FUNC(testUnion2),
        TEST_FUNC(testXor2),
        TEST_FUNC(testOp1d),
        TEST_FUNC(testOp2d),
        TEST_FUNC(testOp3d),
        ...
        TEST_FUNC(cubicOp24d),
        TEST_FUNC(cubicOp23d),
        TEST_FUNC(cubicOp22d),
        TEST_FUNC(cubicOp21d),
        TEST_FUNC(cubicOp20d),
        TEST_FUNC(cubicOp19i),
        TEST_FUNC(cubicOp18d),
        TEST_FUNC(cubicOp17d),
        TEST_FUNC(cubicOp16d),
        TEST_FUNC(cubicOp15d),
        TEST_FUNC(cubicOp14d),
        TEST_FUNC(cubicOp13d),
        TEST_FUNC(cubicOp12d),
        TEST_FUNC(cubicOp11d),
        TEST_FUNC(cubicOp10d),
        TEST_FUNC(cubicOp1i),
        TEST_FUNC(cubicOp9d),
        TEST_FUNC(quadOp9d),
        TEST_FUNC(lineOp9d),
...
one.quadTo(SkBits2Float(0x72727272), SkBits2Float(0x522a5272), SkBits2Float(0x20725252), SkBits2Float(0x72727251));  // 4.80216e+30f, 1.82882e+11f, 2.05254e-19f, 4.80215e+30f
    ...
    options->testOne(two, one, TinyOps::intersect);
}

static void fuzz535151(TestOptions* options) {
    SkPath one;
...
static void bufferOverflow(TestOptions* options) {
    SkPath path;
...
static void fuzz433(TestOptions* options) {
    SkPath path1, path2;
    path1.moveTo(100,0);
    path1.lineTo(60,170);
...
static void fuzz433b(TestOptions* options) {
    SkPath path1, path2;
    path1.setFillType(SkPathFillType::kEvenOdd);
    path1.moveTo(140, 40);
...
static void fuzz487a(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 0);
...
static void fuzz487b(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 0);
path.moveTo(SkBits2Float(0x432c8000), SkBits2Float(0x42c00000));
path.lineTo(SkBits2Float(0x4309999a), SkBits2Float(0x42c00000));
...
static void fuzz714(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 1);
...
static void fuzz1(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 0);
...
static void fuzz753_91(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 0);
...
static void bug597926_0(TestOptions* options) {
SkPath path;
path.setFillType((SkPathFillType) 0);
...
SkPath path2(path);
options->testOne(path1, path2, (TinyOps) 1);
}

static void fuzz1450_0(TestOptions* options) {
SkPath path;
path.moveTo(SkBits2Float(0x43b40000), SkBits2Float(0xcf000000));  // 360, -2.14748e+09f
...
static void fuzz1450_1(TestOptions* options) {
SkPath path;
path.setFillType(SkPathFillType::kEvenOdd);
...
static void fuzz763_9(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 1);
...
static void fuzz763_4(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 1);
...
static void fuzz763_3(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 1);
...
static void fuzz763_5(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 1);
...
path.lineTo(SkBits2Float(0x5b2d2968), SkBits2Float(0x5b2d8c55));  // 4.87407e+16f, 4.88495e+16f
    ...
    SkPath path2(path);
    options->testOne(path1, path2, (TinyOps) 4);
}

static void fuzz763_2(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 1);
...
// crbug.com/626164
static void fuzz763_1c(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 0);
...
// crbug.com/626186
static void fuzz763_1b(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 0);
    path.moveTo(SkBits2Float(0x00000000), SkBits2Float(0x00000000));  // 0, 0
...
static void fuzz763_1a(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 0);
    path.moveTo(SkBits2Float(0x00000000), SkBits2Float(0x00000000));  // 0, 0
...
// crbug.com/627780
static void fuzz763_3a(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 1);
...
// crbug.com/627689
static void fuzz763_5a(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 1);
...
// crbug.com/627401
static void fuzz763_2a(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 1);
...
// crbug.com/627761
static void fuzz763_2b(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 1);
...
static void fuzz763_2c(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 1);
...
path.cubicTo(SkBits2Float(0x544a4a4a), SkBits2Float(0x4a4a4a4a), SkBits2Float(0x2ba1a14a), SkBits2Float(0x4e4a08ff), SkBits2Float(0x4a4a4a4a), SkBits2Float(0xa1a181ff));  // 3.47532e+12f, 3.31432e+06f, 1.14845e-12f, 8.47397e+08f, 3.31432e+06f, -1.09442e-18f
    SkPath path2(path);
    options->testOne(path1, path2, TinyOps::reverseDifference);
}

static void fuzz763_6(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 1);
...
static void fuzz763_7(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 0);
...
static void kfuzz2(TestOptions* options) {
    SkPath path1;
    SkPath path;
...
path.close();
SkPath path2(path);
    options->testOne(path1, path2, TinyOps::exclusiveOr);
}

static void fuzz763_10(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 1);
...
static void fuzz763_11(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 0);
...
static void fuzz763_12(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 1);
path.moveTo(SkBits2Float(0x00000000), SkBits2Float(0x00000000));  // 0, 0
...
static void fuzz763_13(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 1);
...
static void fuzz763_14(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 0);
...
static void fuzz763_15(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 1);
...
static void fuzz763_16(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 0);
...
static void fuzz763_17(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 0);
...
static void fuzz763_18(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 0);
...
static void fuzz763_19(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 1);
...
static void fuzz763_20(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 0);
...
static void fuzz763_21(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 1);
...
static void fuzz763_22(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 1);
...
path.lineTo(SkBits2Float(0x63283ae6), SkBits2Float(0x27282a81));  // 3.1033e+21f, 2.33377e-15f
    ...
    SkPath path2(path);
    options->testOne(path1, path2, (TinyOps) 3);
}

static void fuzz763_23(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 0);
...
static void fuzz763_24(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 1);
...
static void fuzz763_25(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 1);
...
static void fuzz763_26(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 0);
...
static void fuzz763_28(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 0);
...
static void fuzz763_27(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 0);
...
static void fuzz763_29(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 1);
path.moveTo(SkBits2Float(0x00000000), SkBits2Float(0x00000000));  // 0, 0
...
static void fuzz763_30(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 1);
...
static void fuzz763_31(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 1);
...
static void fuzz763_33(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 1);
...
static void fuzz763_32(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 1);
...
static void fuzz763_34(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 1);
...
static void fuzz763_36(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 0);
...
static void fuzz763_35(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 1);
...
static void fuzz763_37(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 0);
...
static void fuzz763_38(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 0);
path.moveTo(SkBits2Float(0x00000000), SkBits2Float(0x00000000));  // 0, 0
...
static void fuzz763_41(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 0);
...
static void fuzz763_40(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 1);
...
static void fuzz763_39(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 0);
...
static void fuzz763_42(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 0);
...
static void fuzz763_43(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 1);
...
static void fuzz763_44(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 1);
...
static void fuzz763_45(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 0);
...
static void fuzz763_46(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 0);
...
static void fuzz763_47(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 1);
...
static void fuzz763_48(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 1);
...
static void fuzz763_49(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 0);
...
static void fuzz763_50(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 1);
...
static void fuzz763_51(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 1);
...
static void fuzz763_52(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 1);
...
static void fuzz763_53(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 1);
...
// hangs 654939
static void fuzz763_54(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 0);
path.moveTo(SkBits2Float(0x00000000), SkBits2Float(0x00000000));  // 0, 0
...
// afl crash
static void fuzz763_55(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 0);
...
// 656149
static void fuzz763_56(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 0);
path.moveTo(SkBits2Float(0x00000000), SkBits2Float(0x00000000));  // 0, 0
...
static void fuzz763_57(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 0);
...
static void fuzzhang_1(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 1);
path.moveTo(SkBits2Float(0x00000000), SkBits2Float(0x00000000));  // 0, 0
...
static void release_13(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 1);
path.setFillType(SkPathFillType::kEvenOdd);
...
static void fuzzhang_2(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 0);
path.setFillType(SkPathFillType::kWinding);
...
static void fuzzhang_3(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 0);
path.setFillType(SkPathFillType::kWinding);
...
static void fuzz754434_1(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 0);
path.setFillType(SkPathFillType::kWinding);
...
static void fuzz754434_2(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 1);
path.setFillType(SkPathFillType::kEvenOdd);
...
static void fuzz754434_3(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 0);
path.setFillType(SkPathFillType::kWinding);
...
static void fuzz754434_4(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 1);
path.setFillType(SkPathFillType::kEvenOdd);
path.moveTo(SkBits2Float(0xff00ff56), SkBits2Float(0x00000000));  // -1.71467e+38f, 0
...
void V0OpFail(TestTrack* track) {
    static std::vector<TestFunc> failTests = {
        ...
        TEST_FUNC(fuzz754434_2),
        TEST_FUNC(fuzz754434_3),
        TEST_FUNC(fuzz754434_4),
        TEST_FUNC(fuzzhang_3),
        TEST_FUNC(fuzzhang_2),
        TEST_FUNC_FAIL(release_13),
        TEST_FUNC(fuzzhang_1),
        TEST_FUNC(fuzz763_57),
        TEST_FUNC(fuzz763_56),
        TEST_FUNC(fuzz763_55),
        TEST_FUNC(fuzz763_54),
        TEST_FUNC(fuzz763_53),
        TEST_FUNC(fuzz763_52),
        TEST_FUNC(fuzz763_51),
        TEST_FUNC_FAIL(fuzz763_50),
        TEST_FUNC(fuzz763_49),
        TEST_FUNC(fuzz763_48),
        TEST_FUNC(fuzz763_47),
        TEST_FUNC_FAIL(fuzz763_46),
        TEST_FUNC(fuzz763_45),
        TEST_FUNC(fuzz763_44),
        TEST_FUNC(fuzz763_43),
        TEST_FUNC(fuzz763_42),
        TEST_FUNC(fuzz763_41),
        TEST_FUNC(fuzz763_40),
        TEST_FUNC(fuzz763_39),
        TEST_FUNC(fuzz763_38),
        TEST_FUNC(fuzz763_37),
        TEST_FUNC(fuzz763_36),
        TEST_FUNC(fuzz763_35),
        ...
        TEST_FUNC(fuzz763_27),
        TEST_FUNC(fuzz763_26),
        TEST_FUNC(fuzz763_25),
        TEST_FUNC(fuzz763_24),
        TEST_FUNC(fuzz763_23),
        TEST_FUNC(fuzz763_22),
        TEST_FUNC(fuzz763_21),
        TEST_FUNC(fuzz763_20),
        TEST_FUNC(fuzz763_19),
        TEST_FUNC(fuzz763_18),
        TEST_FUNC(fuzz763_17),
        TEST_FUNC(fuzz763_16),
        TEST_FUNC(fuzz763_15),
        TEST_FUNC(fuzz763_14),
        TEST_FUNC(fuzz763_13),
        TEST_FUNC(fuzz763_12),
        TEST_FUNC(fuzz763_11),
        TEST_FUNC_FAIL(fuzz763_10),
        TEST_FUNC(kfuzz2),
        TEST_FUNC(fuzz763_7),
        TEST_FUNC(fuzz763_6),
        TEST_FUNC(fuzz763_2c),
        TEST_FUNC(fuzz763_2b),
        TEST_FUNC(fuzz763_2a),
        TEST_FUNC(fuzz763_5a),
        TEST_FUNC(fuzz763_3a),
        TEST_FUNC(fuzz763_1a),
        TEST_FUNC(fuzz763_1b),
        TEST_FUNC_FAIL(fuzz763_1c),
        TEST_FUNC(fuzz763_2),
        TEST_FUNC(fuzz763_5),
        TEST_FUNC(fuzz763_3),
        TEST_FUNC(fuzz763_4),
        TEST_FUNC(fuzz763_9),
        TEST_FUNC_FAIL(fuzz1450_1),
        TEST_FUNC(fuzz1450_0),
