...
static void issue12556(TestOptions* options) {
SkPath patha;
...
static void pentrek1(TestOptions* options) {
SkPath b;
...
b.close();
    options->testOne(left, b, TinyOps::intersect);
}


static void pentrek2(TestOptions* options) {
SkPath b;
...
static void pentrek3(TestOptions* options) {
SkPath b;
...
static void pentrek4(TestOptions* options) {
SkPath b;
...
static void pentrek5(TestOptions* options) {
SkPath b;
...
static void pentrek6(TestOptions* options) {
SkPath b;
...
static void pentrek7(TestOptions* options) {
SkPath b;
...
static void pentrek8(TestOptions* options) {
SkPath b;
...
static void pentrek9(TestOptions* options) {
SkPath b;
...
static void pentrek10(TestOptions* options) {
SkPath b;
...
b.close();
    options->testOne(left, b, TinyOps::difference);
}

static void pentrek11(TestOptions* options) {
SkPath b;
...
static void pentrek12(TestOptions* options) {
SkPath b;
...
static void pentrek13(TestOptions* options) {
SkPath b;
...
void mikeClifton1(TestOptions* options) {
	SkPath circle;
...
//	heart.cubicTo(179912.375000f, 607569.812500f, 106901.476562f, 547671.250000f, 51800.101562f, 590767.250000f);
	...
	options->testOne(circle, heart, TinyOps::difference);
}

void mikeClifton2(TestOptions* options) {
	SkPath circle;
    circle.moveTo(63939.703125f, 507801.593750f);
    circle.cubicTo(26787.699219f, 507802.281250f, -3181.329102f, 537774.250000f, -3181.099854f, 574926.250000f);
    circle.cubicTo(-3180.870850f, 612077.875000f, 26788.080078f, 642048.875000f, 63939.703125f, 642049.625000f);
...
void skiaIssue377820800(TestOptions* options) {
	SkPath circle;
