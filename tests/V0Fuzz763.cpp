...
// originally skia's PathOpsFuzz763Test.cpp,
// optimized for speed, reduced memory, and random access
#include "TinySkiaTests.h"

static void fuzz763_3084(TestOptions* options) {
    SkPath path;
...
static void fuzz763_1823(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 1);
path.moveTo(SkBits2Float(0xc19e6455), SkBits2Float(0xc19e6455));
path.quadTo(SkBits2Float(0xc1399153), SkBits2Float(0xc1e00000), SkBits2Float(0x00000000), SkBits2Float(0xc1e00000));
...
static void fuzz763_378(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 1);
...
static void fuzz763_378b(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 1);
...
static void fuzz763_378c(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 1);
    path.moveTo(-47.1494f, 4.35143f);
...
static void fuzz763_378d(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 1);
path.moveTo(-47.1494f, 4.35143f);
...
static void fuzz763_558(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 1);
...
static void fuzz763_378a(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 1);
...
static void fuzz763_378a_1(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 1);
path.moveTo(SkBits2Float(0xc23c98fa), SkBits2Float(0x408b3eec));
path.quadTo(SkBits2Float(0xc22fcb5c), SkBits2Float(0x405f9a18), SkBits2Float(0xc22450bb), SkBits2Float(0x40a4d200));
...
static void fuzz763_8712(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 1);
...
static void fuzz763_8712a(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 1);
path.moveTo(SkBits2Float(0xc23c98fa), SkBits2Float(0x408b3eec));
path.quadTo(SkBits2Float(0xc22fcb5c), SkBits2Float(0x405f9a18), SkBits2Float(0xc22450bb), SkBits2Float(0x40a4d200));
...
static void fuzz763_4014(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 1);
...
static void fuzz763_4014a(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 1);
...
static void fuzz763_1404(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 1);
...
static void fuzz763_4713(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 1);
...
static void fuzz763_24588(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 1);
...
static void fuzz763_20016(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 1);
...
static void fuzz763_17370(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 1);
...
static void fuzz763_35322(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 1);
...
static void fuzz763_849020(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 1);
...
static void fuzz763_1597464(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 1);
...
static void fuzz763_34974(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 1);
#if 00
...
static void fuzz763_2211264(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 1);
...
static void fuzz763_4628016(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 1);
...
static void fuzz763_6411089(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 1);
...
static void fuzz763_3283699(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 1);
...
static void fuzz763_1026368(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 1);
...
static void fuzz763_5485218(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 1);
...
static void fuzz763_2674194(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 1);
...
static void fuzz763_10022998(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 1);
...
void V0Fuzz763(TestTrack* track) {
