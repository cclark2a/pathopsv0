...
// originally skia's PathOpsSimplifyTest.cpp,
// optimized for speed, reduced memory, and random access
#include "TinySkiaTests.h"

static void testLine1(TestOptions* options) {
    SkPath path;
    path.moveTo(2,0);
    path.lineTo(1,1);
    path.lineTo(0,0);
...
static void testLine1x(TestOptions* options) {
    SkPath path;
...
static void testLine2(TestOptions* options) {
    SkPath path;
...
static void testLine2x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    addInnerCWTriangle(path);
    addOuterCWTriangle(path);
...
static void testLine3(TestOptions* options) {
    SkPath path;
...
static void testLine3x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    addInnerCCWTriangle(path);
    addOuterCWTriangle(path);
...
static void testLine3a(TestOptions* options) {
    SkPath path;
    addInnerCWTriangle(path);
...
static void testLine3ax(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    addInnerCWTriangle(path);
    addOuterCCWTriangle(path);
...
static void testLine3b(TestOptions* options) {
    SkPath path;
    addInnerCCWTriangle(path);
    addOuterCCWTriangle(path);
    options->testOne(path);
...
static void testLine3bx(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    addInnerCCWTriangle(path);
    addOuterCCWTriangle(path);
...
static void testLine4(TestOptions* options) {
    SkPath path;
    addOuterCCWTriangle(path);
    addOuterCWTriangle(path);
    options->testOne(path);
...
static void testLine4x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    addOuterCCWTriangle(path);
    addOuterCWTriangle(path);
...
static void testLine5(TestOptions* options) {
    SkPath path;
    addOuterCWTriangle(path);
    addOuterCWTriangle(path);
    options->testOne(path);
...
static void testLine5x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    addOuterCWTriangle(path);
    addOuterCWTriangle(path);
...
static void testLine6(TestOptions* options) {
    SkPath path;
    path.moveTo(0,0);
    path.lineTo(4,0);
    path.lineTo(2,2);
...
static void testLine6x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.moveTo(0,0);
    path.lineTo(4,0);
...
static void testLine7(TestOptions* options) {
    SkPath path;
    path.moveTo(0,0);
    path.lineTo(4,0);
    path.lineTo(2,2);
...
static void testLine7x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.moveTo(0,0);
    path.lineTo(4,0);
...
static void testLine7a(TestOptions* options) {
    SkPath path;
    path.moveTo(0,0);
    path.lineTo(4,0);
    path.lineTo(2,2);
...
static void testLine7ax(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.moveTo(0,0);
    path.lineTo(4,0);
...
static void testLine7b(TestOptions* options) {
    SkPath path;
    path.moveTo(0,0);
    path.lineTo(4,0);
    path.close();
...
static void testLine7bx(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.moveTo(0,0);
    path.lineTo(4,0);
...
static void testLine8(TestOptions* options) {
    SkPath path;
    path.moveTo(0,4);
    path.lineTo(4,4);
    path.lineTo(2,2);
...
static void testLine8x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.moveTo(0,4);
    path.lineTo(4,4);
...
static void testLine9(TestOptions* options) {
    SkPath path;
    path.moveTo(0,4);
    path.lineTo(4,4);
    path.lineTo(2,2);
...
static void testLine9x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.moveTo(0,4);
    path.lineTo(4,4);
...
static void testLine10(TestOptions* options) {
    SkPath path;
    path.moveTo(0,4);
    path.lineTo(4,4);
    path.lineTo(2,2);
...
static void testLine10x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.moveTo(0,4);
    path.lineTo(4,4);
...
static void testLine10a(TestOptions* options) {
    SkPath path;
    path.moveTo(0,4);
    path.lineTo(8,4);
    path.lineTo(4,0);
...
static void testLine10ax(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.moveTo(0,4);
    path.lineTo(8,4);
...
static void testLine11(TestOptions* options) {
    SkPath path;
    addCWContainer(path);
    addCWContents(path);
    options->testOne(path);
...
static void testLine11x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    addCWContainer(path);
    addCWContents(path);
...
static void testLine12(TestOptions* options) {
    SkPath path;
...
static void testLine12x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    addCCWContainer(path);
    addCWContents(path);
...
static void testLine13(TestOptions* options) {
    SkPath path;
    addCWContainer(path);
    addCCWContents(path);
    options->testOne(path);
...
static void testLine13x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    addCWContainer(path);
    addCCWContents(path);
...
static void testLine14(TestOptions* options) {
    SkPath path;
    addCCWContainer(path);
    addCCWContents(path);
    options->testOne(path);
...
static void testLine14x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    addCCWContainer(path);
    addCCWContents(path);
...
static void testLine15(TestOptions* options) {
    SkPath path;
    path.addRect(0, 0, 9, 9, SkPathDirection::kCW);
    options->testOne(path);
}

static void testLine15x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.addRect(0, 0, 9, 9, SkPathDirection::kCW);
    options->testOne(path);
...
static void testLine16(TestOptions* options) {
    SkPath path;
...
static void testLine16x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.addRect(0, 0, 12, 12, SkPathDirection::kCW);
    path.addRect(0, 4, 9, 9, SkPathDirection::kCW);
...
static void testLine17(TestOptions* options) {
    SkPath path;
    path.addRect(0, 0, 12, 12, SkPathDirection::kCW);
...
static void testLine17x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.addRect(0, 0, 12, 12, SkPathDirection::kCW);
    path.addRect(4, 12, 13, 13, SkPathDirection::kCW);
...
static void testLine18(TestOptions* options) {
    SkPath path;
    path.addRect(0, 0, 12, 12, SkPathDirection::kCW);
...
static void testLine18x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.addRect(0, 0, 12, 12, SkPathDirection::kCW);
    path.addRect(12, 4, 21, 21, SkPathDirection::kCW);
...
static void testLine19(TestOptions* options) {
    SkPath path;
    path.addRect(0, 0, 12, 12, SkPathDirection::kCW);
...
static void testLine19x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.addRect(0, 0, 12, 12, SkPathDirection::kCW);
    path.addRect(12, 16, 21, 21, SkPathDirection::kCW);
...
static void testLine20(TestOptions* options) {
    SkPath path;
...
static void testLine20x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.addRect(0, 12, 12, 12, SkPathDirection::kCW);
    path.addRect(0, 12, 9, 9, SkPathDirection::kCW);
...
static void testLine21(TestOptions* options) {
    SkPath path;
    path.addRect(0, 12, 12, 12, SkPathDirection::kCW);
...
static void testLine21x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.addRect(0, 12, 12, 12, SkPathDirection::kCW);
    path.addRect(0, 16, 9, 9, SkPathDirection::kCW);
...
static void testLine22(TestOptions* options) {
    SkPath path;
    path.addRect(0, 12, 12, 12, SkPathDirection::kCW);
    path.addRect(4, 12, 13, 13, SkPathDirection::kCW);
    options->testOne(path);
...
static void testLine22x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.addRect(0, 12, 12, 12, SkPathDirection::kCW);
    path.addRect(4, 12, 13, 13, SkPathDirection::kCW);
...
static void testLine23(TestOptions* options) {
    SkPath path;
    path.addRect(0, 12, 12, 12, SkPathDirection::kCW);
...
static void testLine23x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.addRect(0, 12, 12, 12, SkPathDirection::kCW);
    path.addRect(12, 0, 21, 21, SkPathDirection::kCW);
...
static void testLine24a(TestOptions* options) {
    SkPath path;
    path.moveTo(2,0);
    path.lineTo(4,4);
    path.lineTo(0,4);
...
static void testLine24ax(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.moveTo(2,0);
    path.lineTo(4,4);
...
static void testLine24(TestOptions* options) {
    SkPath path;
...
static void testLine24x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.addRect(0, 18, 12, 12, SkPathDirection::kCW);
    path.addRect(4, 12, 13, 13, SkPathDirection::kCW);
...
static void testLine25(TestOptions* options) {
    SkPath path;
...
static void testLine25x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.addRect(0, 6, 12, 12, SkPathDirection::kCW);
    path.addRect(12, 0, 21, 21, SkPathDirection::kCW);
...
static void testLine26(TestOptions* options) {
    SkPath path;
    path.addRect(0, 18, 12, 12, SkPathDirection::kCW);
    path.addRect(0, 12, 9, 9, SkPathDirection::kCW);
    options->testOne(path);
...
static void testLine26x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.addRect(0, 18, 12, 12, SkPathDirection::kCW);
    path.addRect(0, 12, 9, 9, SkPathDirection::kCW);
...
static void testLine27(TestOptions* options) {
    SkPath path;
    path.addRect(0, 18, 12, 12, SkPathDirection::kCW);
...
static void testLine27x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.addRect(0, 18, 12, 12, SkPathDirection::kCW);
    path.addRect(12, 8, 21, 21, SkPathDirection::kCW);
...
static void testLine28(TestOptions* options) {
    SkPath path;
    path.addRect(0, 6, 12, 12, SkPathDirection::kCW);
    path.addRect(0, 0, 9, 9, SkPathDirection::kCW);
    options->testOne(path);
...
static void testLine28x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.addRect(0, 6, 12, 12, SkPathDirection::kCW);
    path.addRect(0, 0, 9, 9, SkPathDirection::kCW);
...
static void testLine29(TestOptions* options) {
    SkPath path;
    path.addRect(0, 18, 12, 12, SkPathDirection::kCW);
...
static void testLine29x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.addRect(0, 18, 12, 12, SkPathDirection::kCW);
    path.addRect(12, 12, 21, 21, SkPathDirection::kCW);
...
static void testLine30(TestOptions* options) {
    SkPath path;
...
static void testLine30x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.addRect(0, 0, 20, 20, SkPathDirection::kCW);
    path.addRect(0, 0, 12, 12, SkPathDirection::kCW);
...
static void testLine31(TestOptions* options) {
    SkPath path;
    path.addRect(0, 0, 20, 20, SkPathDirection::kCW);
    path.addRect(0, 0, 12, 12, SkPathDirection::kCW);
    path.addRect(0, 4, 9, 9, SkPathDirection::kCW);
...
static void testLine31x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.addRect(0, 0, 20, 20, SkPathDirection::kCW);
    path.addRect(0, 0, 12, 12, SkPathDirection::kCW);
...
static void testLine32(TestOptions* options) {
    SkPath path;
    path.addRect(0, 0, 20, 20, SkPathDirection::kCW);
    path.addRect(0, 0, 12, 12, SkPathDirection::kCW);
    path.addRect(4, 12, 13, 13, SkPathDirection::kCW);
...
static void testLine32x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.addRect(0, 0, 20, 20, SkPathDirection::kCW);
    path.addRect(0, 0, 12, 12, SkPathDirection::kCW);
...
static void testLine33(TestOptions* options) {
    SkPath path;
    path.addRect(0, 0, 20, 20, SkPathDirection::kCW);
    path.addRect(0, 0, 12, 12, SkPathDirection::kCW);
...
static void testLine33x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.addRect(0, 0, 20, 20, SkPathDirection::kCW);
    path.addRect(0, 0, 12, 12, SkPathDirection::kCW);
...
static void testLine34(TestOptions* options) {
    SkPath path;
    path.addRect(0, 0, 20, 20, SkPathDirection::kCW);
    path.addRect(0, 6, 12, 12, SkPathDirection::kCW);
    path.addRect(4, 12, 13, 13, SkPathDirection::kCW);
...
static void testLine34x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.addRect(0, 0, 20, 20, SkPathDirection::kCW);
    path.addRect(0, 6, 12, 12, SkPathDirection::kCW);
...
static void testLine35(TestOptions* options) {
    SkPath path;
    path.addRect(0, 0, 20, 20, SkPathDirection::kCW);
...
static void testLine35x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.addRect(0, 0, 20, 20, SkPathDirection::kCW);
    path.addRect(6, 0, 18, 18, SkPathDirection::kCW);
...
static void testLine36(TestOptions* options) {
    SkPath path;
...
static void testLine36x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.addRect(0, 10, 20, 20, SkPathDirection::kCW);
    path.addRect(6, 12, 18, 18, SkPathDirection::kCW);
...
static void testLine37(TestOptions* options) {
    SkPath path;
...
static void testLine37x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.addRect(0, 20, 20, 20, SkPathDirection::kCW);
    path.addRect(18, 24, 30, 30, SkPathDirection::kCW);
...
static void testLine38(TestOptions* options) {
    SkPath path;
...
static void testLine38x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.addRect(10, 0, 30, 30, SkPathDirection::kCW);
    path.addRect(6, 12, 18, 18, SkPathDirection::kCW);
...
static void testLine40(TestOptions* options) {
    SkPath path;
    path.addRect(10, 0, 30, 30, SkPathDirection::kCW);
...
static void testLine40x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.addRect(10, 0, 30, 30, SkPathDirection::kCW);
    path.addRect(12, 18, 24, 24, SkPathDirection::kCW);
...
static void testLine41(TestOptions* options) {
    SkPath path;
    path.addRect(0, 0, 20, 20, SkPathDirection::kCW);
    path.addRect(18, 24, 30, 30, SkPathDirection::kCW);
    path.addRect(12, 0, 21, 21, SkPathDirection::kCW);
...
static void testLine41x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.addRect(0, 0, 20, 20, SkPathDirection::kCW);
    path.addRect(18, 24, 30, 30, SkPathDirection::kCW);
...
static void testLine42(TestOptions* options) {
    SkPath path;
    path.addRect(0, 0, 20, 20, SkPathDirection::kCW);
    path.addRect(0, 0, 12, 12, SkPathDirection::kCW);
...
static void testLine42x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.addRect(0, 0, 20, 20, SkPathDirection::kCW);
    path.addRect(0, 0, 12, 12, SkPathDirection::kCW);
...
static void testLine43(TestOptions* options) {
    SkPath path;
    path.addRect(0, 0, 20, 20, SkPathDirection::kCW);
...
static void testLine43x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.addRect(0, 0, 20, 20, SkPathDirection::kCW);
    path.addRect(6, 24, 18, 18, SkPathDirection::kCW);
...
static void testLine44(TestOptions* options) {
    SkPath path;
...
static void testLine44x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.addRect(10, 40, 30, 30, SkPathDirection::kCW);
    path.addRect(18, 0, 30, 30, SkPathDirection::kCW);
...
static void testLine45(TestOptions* options) {
    SkPath path;
    path.addRect(10, 0, 30, 30, SkPathDirection::kCW);
    path.addRect(18, 0, 30, 30, SkPathDirection::kCW);
...
static void testLine45x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.addRect(10, 0, 30, 30, SkPathDirection::kCW);
    path.addRect(18, 0, 30, 30, SkPathDirection::kCW);
...
static void testLine46(TestOptions* options) {
    SkPath path;
    path.addRect(10, 40, 30, 30, SkPathDirection::kCW);
...
static void testLine46x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.addRect(10, 40, 30, 30, SkPathDirection::kCW);
    path.addRect(24, 0, 36, 36, SkPathDirection::kCW);
...
static void testLine47(TestOptions* options) {
    SkPath path;
    path.addRect(0, 0, 20, 20, SkPathDirection::kCW);
    path.addRect(0, 0, 12, 12, SkPathDirection::kCW);
...
static void testLine47x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.addRect(0, 0, 20, 20, SkPathDirection::kCW);
    path.addRect(0, 0, 12, 12, SkPathDirection::kCW);
...
static void testLine48(TestOptions* options) {
    SkPath path;
    path.addRect(0, 0, 20, 20, SkPathDirection::kCW);
    path.addRect(0, 6, 12, 12, SkPathDirection::kCW);
    path.addRect(0, 0, 9, 9, SkPathDirection::kCCW);
...
static void testLine48x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.addRect(0, 0, 20, 20, SkPathDirection::kCW);
    path.addRect(0, 6, 12, 12, SkPathDirection::kCW);
...
static void testLine49(TestOptions* options) {
    SkPath path;
    path.addRect(0, 0, 20, 20, SkPathDirection::kCW);
    path.addRect(0, 0, 12, 12, SkPathDirection::kCW);
    path.addRect(0, 0, 9, 9, SkPathDirection::kCW);
...
static void testLine49x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.addRect(0, 0, 20, 20, SkPathDirection::kCW);
    path.addRect(0, 0, 12, 12, SkPathDirection::kCW);
...
static void testLine50(TestOptions* options) {
    SkPath path;
...
static void testLine50x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.addRect(10, 30, 30, 30, SkPathDirection::kCW);
    path.addRect(24, 20, 36, 30, SkPathDirection::kCW);
...
static void testLine51(TestOptions* options) {
    SkPath path;
    path.addRect(0, 0, 20, 20, SkPathDirection::kCW);
    path.addRect(0, 12, 12, 12, SkPathDirection::kCW);
...
static void testLine51x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.addRect(0, 0, 20, 20, SkPathDirection::kCW);
    path.addRect(0, 12, 12, 12, SkPathDirection::kCW);
...
static void testLine52(TestOptions* options) {
    SkPath path;
...
static void testLine52x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.addRect(0, 30, 20, 20, SkPathDirection::kCW);
    path.addRect(6, 20, 18, 30, SkPathDirection::kCW);
...
static void testLine53(TestOptions* options) {
    SkPath path;
    path.addRect(10, 30, 30, 30, SkPathDirection::kCW);
...
static void testLine53x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.addRect(10, 30, 30, 30, SkPathDirection::kCW);
    path.addRect(12, 20, 24, 30, SkPathDirection::kCW);
...
static void testLine54(TestOptions* options) {
    SkPath path;
    path.addRect(0, 0, 20, 20, SkPathDirection::kCW);
    path.addRect(6, 0, 18, 18, SkPathDirection::kCW);
...
static void testLine54x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.addRect(0, 0, 20, 20, SkPathDirection::kCW);
    path.addRect(6, 0, 18, 18, SkPathDirection::kCW);
...
static void testLine55(TestOptions* options) {
    SkPath path;
    path.addRect(0, 0, 20, 20, SkPathDirection::kCW);
...
static void testLine55x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.addRect(0, 0, 20, 20, SkPathDirection::kCW);
    path.addRect(6, 6, 18, 18, SkPathDirection::kCW);
...
static void testLine56(TestOptions* options) {
    SkPath path;
    path.addRect(0, 20, 20, 20, SkPathDirection::kCW);
...
static void testLine56x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.addRect(0, 20, 20, 20, SkPathDirection::kCW);
    path.addRect(18, 20, 30, 30, SkPathDirection::kCW);
...
static void testLine57(TestOptions* options) {
    SkPath path;
...
static void testLine57x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.addRect(20, 0, 40, 40, SkPathDirection::kCW);
    path.addRect(20, 0, 30, 40, SkPathDirection::kCW);
...
static void testLine58(TestOptions* options) {
    SkPath path;
    path.addRect(0, 0, 20, 20, SkPathDirection::kCW);
...
static void testLine58x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.addRect(0, 0, 20, 20, SkPathDirection::kCW);
    path.addRect(0, 0, 12, 12, SkPathDirection::kCCW);
...
static void testLine59(TestOptions* options) {
    SkPath path;
    path.addRect(0, 0, 20, 20, SkPathDirection::kCW);
...
static void testLine59x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.addRect(0, 0, 20, 20, SkPathDirection::kCW);
    path.addRect(6, 6, 18, 18, SkPathDirection::kCCW);
...
static void testLine60(TestOptions* options) {
    SkPath path;
    path.addRect(0, 0, 20, 20, SkPathDirection::kCW);
...
static void testLine60x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.addRect(0, 0, 20, 20, SkPathDirection::kCW);
    path.addRect(6, 12, 18, 18, SkPathDirection::kCCW);
...
static void testLine61(TestOptions* options) {
    SkPath path;
    path.addRect(0, 0, 20, 20, SkPathDirection::kCW);
...
static void testLine61x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.addRect(0, 0, 20, 20, SkPathDirection::kCW);
    path.addRect(12, 0, 24, 24, SkPathDirection::kCCW);
...
static void testLine62(TestOptions* options) {
    SkPath path;
...
static void testLine62x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.addRect(0, 0, 60, 60, SkPathDirection::kCW);
    path.addRect(0, 0, 20, 20, SkPathDirection::kCW);
...
static void testLine63(TestOptions* options) {
    SkPath path;
    path.addRect(0, 0, 60, 60, SkPathDirection::kCW);
    path.addRect(0, 10, 20, 20, SkPathDirection::kCW);
...
static void testLine63x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.addRect(0, 0, 60, 60, SkPathDirection::kCW);
    path.addRect(0, 10, 20, 20, SkPathDirection::kCW);
...
static void testLine64(TestOptions* options) {
    SkPath path;
    path.addRect(0, 0, 60, 60, SkPathDirection::kCW);
    path.addRect(10, 40, 30, 30, SkPathDirection::kCW);
...
static void testLine64x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.addRect(0, 0, 60, 60, SkPathDirection::kCW);
    path.addRect(10, 40, 30, 30, SkPathDirection::kCW);
...
static void testLine65(TestOptions* options) {
    SkPath path;
    path.addRect(0, 0, 60, 60, SkPathDirection::kCW);
    path.addRect(10, 0, 30, 30, SkPathDirection::kCW);
    path.addRect(24, 0, 36, 36, SkPathDirection::kCW);
...
static void testLine65x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.addRect(0, 0, 60, 60, SkPathDirection::kCW);
    path.addRect(10, 0, 30, 30, SkPathDirection::kCW);
...
static void testLine66(TestOptions* options) {
    SkPath path;
    path.addRect(0, 0, 60, 60, SkPathDirection::kCW);
    path.addRect(0, 30, 20, 20, SkPathDirection::kCW);
    path.addRect(12, 20, 24, 30, SkPathDirection::kCW);
...
static void testLine66x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.addRect(0, 0, 60, 60, SkPathDirection::kCW);
    path.addRect(0, 30, 20, 20, SkPathDirection::kCW);
...
static void testLine67(TestOptions* options) {
    SkPath path;
    path.addRect(0, 0, 60, 60, SkPathDirection::kCW);
    path.addRect(10, 40, 30, 30, SkPathDirection::kCW);
    path.addRect(24, 20, 36, 30, SkPathDirection::kCW);
...
static void testLine67x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.addRect(0, 0, 60, 60, SkPathDirection::kCW);
    path.addRect(10, 40, 30, 30, SkPathDirection::kCW);
...
static void testLine68a(TestOptions* options) {
    SkPath path;
...
static void testLine68ax(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.addRect(0, 0, 8, 8, SkPathDirection::kCW);
    path.addRect(2, 2, 6, 6, SkPathDirection::kCW);
...
static void testLine68b(TestOptions* options) {
    SkPath path;
    path.addRect(0, 0, 8, 8, SkPathDirection::kCW);
...
static void testLine68bx(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.addRect(0, 0, 8, 8, SkPathDirection::kCW);
    path.addRect(2, 2, 6, 6, SkPathDirection::kCCW);
...
static void testLine68c(TestOptions* options) {
    SkPath path;
...
static void testLine68cx(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.addRect(0, 0, 8, 8, SkPathDirection::kCCW);
    path.addRect(2, 2, 6, 6, SkPathDirection::kCW);
...
static void testLine68d(TestOptions* options) {
    SkPath path;
    path.addRect(0, 0, 8, 8, SkPathDirection::kCCW);
    path.addRect(2, 2, 6, 6, SkPathDirection::kCCW);
    path.addRect(1, 2, 4, 2, SkPathDirection::kCW);
...
static void testLine68dx(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.addRect(0, 0, 8, 8, SkPathDirection::kCCW);
    path.addRect(2, 2, 6, 6, SkPathDirection::kCCW);
...
static void testLine68e(TestOptions* options) {
    SkPath path;
    path.addRect(0, 0, 8, 8, SkPathDirection::kCW);
    path.addRect(0, 0, 8, 8, SkPathDirection::kCW);
    path.addRect(2, 2, 6, 6, SkPathDirection::kCCW);
...
static void testLine68ex(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.addRect(0, 0, 8, 8, SkPathDirection::kCW);
    path.addRect(0, 0, 8, 8, SkPathDirection::kCW);
...
static void testLine68f(TestOptions* options) {
    SkPath path;
    path.addRect(0, 0, 8, 8, SkPathDirection::kCW);
    path.addRect(2, 2, 6, 6, SkPathDirection::kCCW);
    path.addRect(2, 2, 6, 6, SkPathDirection::kCCW);
...
static void testLine68fx(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.addRect(0, 0, 8, 8, SkPathDirection::kCW);
    path.addRect(2, 2, 6, 6, SkPathDirection::kCCW);
...
static void testLine68g(TestOptions* options) {
    SkPath path;
    path.addRect(0, 0, 8, 8, SkPathDirection::kCW);
    path.addRect(0, 0, 8, 8, SkPathDirection::kCW);
    path.addRect(2, 2, 6, 6, SkPathDirection::kCCW);
...
static void testLine68gx(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.addRect(0, 0, 8, 8, SkPathDirection::kCW);
    path.addRect(0, 0, 8, 8, SkPathDirection::kCW);
...
static void testLine68h(TestOptions* options) {
    SkPath path;
    path.addRect(0, 0, 8, 8, SkPathDirection::kCW);
    path.addRect(2, 2, 6, 6, SkPathDirection::kCCW);
    path.addRect(2, 2, 6, 6, SkPathDirection::kCCW);
...
static void testLine68hx(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.addRect(0, 0, 8, 8, SkPathDirection::kCW);
    path.addRect(2, 2, 6, 6, SkPathDirection::kCCW);
...
static void testLine69(TestOptions* options) {
    SkPath path;
    path.addRect(0, 20, 20, 20, SkPathDirection::kCW);
...
static void testLine69x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.addRect(0, 20, 20, 20, SkPathDirection::kCW);
    path.addRect(0, 20, 12, 30, SkPathDirection::kCW);
...
static void testLine70(TestOptions* options) {
    SkPath path;
    path.addRect(0, 0, 20, 20, SkPathDirection::kCW);
...
static void testLine70x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.addRect(0, 0, 20, 20, SkPathDirection::kCW);
    path.addRect(0, 24, 12, 12, SkPathDirection::kCW);
...
static void testLine71(TestOptions* options) {
    SkPath path;
    path.addRect(0, 0, 20, 20, SkPathDirection::kCW);
...
static void testLine71x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.addRect(0, 0, 20, 20, SkPathDirection::kCW);
    path.addRect(12, 0, 24, 24, SkPathDirection::kCW);
...
static void testLine72(TestOptions* options) {
    SkPath path;
    path.addRect(0, 0, 60, 60, SkPathDirection::kCW);
    path.addRect(10, 40, 30, 30, SkPathDirection::kCW);
    path.addRect(6, 20, 18, 30, SkPathDirection::kCW);
...
static void testLine72x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.addRect(0, 0, 60, 60, SkPathDirection::kCW);
    path.addRect(10, 40, 30, 30, SkPathDirection::kCW);
...
static void testLine73(TestOptions* options) {
    SkPath path;
    path.addRect(0, 0, 60, 60, SkPathDirection::kCW);
...
static void testLine73x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.addRect(0, 0, 60, 60, SkPathDirection::kCW);
    path.addRect(0, 40, 20, 20, SkPathDirection::kCW);
...
static void testLine74(TestOptions* options) {
    SkPath path;
...
static void testLine74x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.addRect(20, 30, 40, 40, SkPathDirection::kCW);
    path.addRect(24, 20, 36, 30, SkPathDirection::kCCW);
...
static void testLine75(TestOptions* options) {
    SkPath path;
    path.addRect(0, 0, 60, 60, SkPathDirection::kCW);
...
static void testLine75x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.addRect(0, 0, 60, 60, SkPathDirection::kCW);
    path.addRect(10, 0, 30, 30, SkPathDirection::kCCW);
...
static void testLine76(TestOptions* options) {
    SkPath path;
...
static void testLine76x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.addRect(36, 0, 66, 60, SkPathDirection::kCW);
    path.addRect(10, 20, 40, 30, SkPathDirection::kCW);
...
static void testLine77(TestOptions* options) {
    SkPath path;
    path.addRect(20, 0, 40, 40, SkPathDirection::kCW);
...
static void testLine77x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.addRect(20, 0, 40, 40, SkPathDirection::kCW);
    path.addRect(24, 6, 36, 36, SkPathDirection::kCCW);
...
static void testLine78(TestOptions* options) {
    SkPath path;
...
static void testLine78x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.addRect(0, 0, 30, 60, SkPathDirection::kCW);
    path.addRect(10, 20, 30, 30, SkPathDirection::kCCW);
...
static void testLine79(TestOptions* options) {
    SkPath path;
...
static void testLine79x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.addRect(0, 36, 60, 30, SkPathDirection::kCW);
    path.addRect(10, 30, 40, 30, SkPathDirection::kCW);
...
static void testLine81(TestOptions* options) {
    SkPath path;
...
static void testDegenerate1(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.lineTo(0, 0);
    path.lineTo(2, 0);
...
static void testDegenerate1x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.moveTo(0, 0);
    path.lineTo(0, 0);
...
static void testDegenerate2(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.lineTo(0, 0);
    path.lineTo(0, 0);
...
static void testDegenerate2x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.moveTo(0, 0);
    path.lineTo(0, 0);
...
static void testDegenerate3(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.lineTo(2, 0);
    path.lineTo(1, 0);
...
static void testDegenerate3x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.moveTo(0, 0);
    path.lineTo(2, 0);
...
static void testDegenerate4(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.lineTo(1, 0);
    path.lineTo(1, 3);
...
static void testDegenerate4x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.moveTo(0, 0);
    path.lineTo(1, 0);
...
static void testNondegenerate1(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.lineTo(3, 0);
    path.lineTo(1, 3);
...
static void testNondegenerate1x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.moveTo(0, 0);
    path.lineTo(3, 0);
...
static void testNondegenerate2(TestOptions* options) {
    SkPath path;
    path.moveTo(1, 0);
    path.lineTo(0, 1);
    path.lineTo(1, 1);
...
static void testNondegenerate2x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.moveTo(1, 0);
    path.lineTo(0, 1);
...
static void testNondegenerate3(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.lineTo(1, 0);
    path.lineTo(2, 1);
...
static void testNondegenerate3x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.moveTo(0, 0);
    path.lineTo(1, 0);
...
static void testNondegenerate4(TestOptions* options) {
    SkPath path;
    path.moveTo(1, 0);
    path.lineTo(0, 1);
    path.lineTo(1, 2);
...
static void testNondegenerate4x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.moveTo(1, 0);
    path.lineTo(0, 1);
...
static void testQuadralateral5(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.lineTo(0, 0);
    path.lineTo(1, 0);
...
static void testQuadralateral5x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.moveTo(0, 0);
    path.lineTo(0, 0);
...
static void testQuadralateral6(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.lineTo(0, 0);
    path.lineTo(1, 0);
...
static void testQuadralateral6x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.moveTo(0, 0);
    path.lineTo(0, 0);
...
static void testFauxQuadralateral6(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.lineTo(1, 0);
    path.lineTo(1, 1);
...
static void testFauxQuadralateral6x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.moveTo(0, 0);
    path.lineTo(1, 0);
...
static void testFauxQuadralateral6a(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.lineTo(3, 0);
    path.lineTo(3, 3);
...
static void testFauxQuadralateral6ax(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.moveTo(0, 0);
    path.lineTo(3, 0);
...
static void testFauxQuadralateral6b(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.lineTo(3, 0);
    path.lineTo(3, 3);
...
static void testFauxQuadralateral6bx(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.moveTo(0, 0);
    path.lineTo(3, 0);
...
static void testFauxQuadralateral6c(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.lineTo(3, 3);
    path.lineTo(3, 0);
...
static void testFauxQuadralateral6cx(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.moveTo(0, 0);
    path.lineTo(3, 3);
...
static void testFauxQuadralateral6d(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.lineTo(3, 3);
    path.lineTo(3, 0);
...
static void testFauxQuadralateral6dx(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.moveTo(0, 0);
    path.lineTo(3, 3);
...
static void testQuadralateral6a(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.lineTo(0, 0);
    path.lineTo(3, 0);
...
static void testQuadralateral6ax(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.moveTo(0, 0);
    path.lineTo(0, 0);
...
static void testQuadralateral7(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.lineTo(0, 0);
    path.lineTo(1, 0);
...
static void testQuadralateral7x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.moveTo(0, 0);
    path.lineTo(0, 0);
...
static void testQuadralateral8(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.lineTo(3, 1);
    path.lineTo(1, 3);
...
static void testQuadralateral8x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.moveTo(0, 0);
    path.lineTo(3, 1);
...
static void testQuadralateral9(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.lineTo(1, 0);
    path.lineTo(1, 2);
...
static void testQuadralateral9x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.moveTo(0, 0);
    path.lineTo(1, 0);
...
static void testLine1a(TestOptions* options) {
    SkPath path;
...
static void testLine1ax(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.addRect(0, 0, 12, 12, SkPathDirection::kCW);
    path.addRect(4, 0, 13, 13, SkPathDirection::kCCW);
...
static void testLine2ax(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.addRect(0, 20, 20, 20, SkPathDirection::kCW);
    path.addRect(0, 20, 12, 30, SkPathDirection::kCW);
...
static void testLine3aax(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.addRect(10, 30, 30, 30, SkPathDirection::kCW);
    path.addRect(18, 20, 30, 30, SkPathDirection::kCCW);
...
static void testLine4ax(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.addRect(10, 30, 30, 30, SkPathDirection::kCW);
    path.addRect(24, 20, 36, 30, SkPathDirection::kCCW);
...
static void testQuadratic1(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.quadTo(0, 0, 0, 0);
    path.lineTo(1, 0);
...
static void testQuadratic1x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.moveTo(0, 0);
    path.quadTo(0, 0, 0, 0);
...
static void testQuadratic2(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.quadTo(0, 0, 0, 0);
    path.lineTo(3, 0);
...
static void testQuadratic2x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.moveTo(0, 0);
    path.quadTo(0, 0, 0, 0);
...
static void testQuadratic3(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.quadTo(0, 0, 1, 0);
    path.lineTo(0, 2);
...
static void testQuadratic3x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.moveTo(0, 0);
    path.quadTo(0, 0, 1, 0);
...
static void testQuadratic4(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.quadTo(0, 0, 1, 0);
    path.lineTo(0, 2);
...
static void testQuadratic4x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.moveTo(0, 0);
    path.quadTo(0, 0, 1, 0);
...
static void testQuadratic5(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.quadTo(0, 0, 0, 0);
    path.lineTo(0, 1);
...
static void testQuadratic6(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.quadTo(0, 0, 1, 0);
    path.lineTo(2, 1);
...
static void testQuadratic7(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.quadTo(0, 0, 1, 0);
    path.lineTo(3, 1);
...
static void testQuadratic8(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.quadTo(0, 0, 1, 0);
    path.lineTo(0, 2);
...
static void testQuadratic9(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.quadTo(0, 0, 1, 0);
    path.lineTo(3, 1);
...
static void testQuadratic14(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.quadTo(0, 0, 1, 0);
    path.lineTo(3, 2);
...
static void testQuadratic15(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.quadTo(0, 0, 1, 0);
    path.lineTo(1, 3);
...
static void testQuadratic17x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.moveTo(0, 0);
    path.quadTo(0, 0, 3, 1);
...
static void testQuadratic18(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.quadTo(1, 0, 0, 1);
    path.lineTo(0, 1);
...
static void testQuadratic19(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.quadTo(1, 0, 0, 1);
    path.lineTo(0, 1);
...
static void testQuadratic20(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.quadTo(1, 0, 0, 1);
    path.lineTo(0, 1);
...
static void testQuadratic21(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.quadTo(1, 0, 0, 1);
    path.lineTo(0, 1);
...
static void testQuadratic22(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.quadTo(1, 0, 0, 1);
    path.lineTo(0, 1);
...
static void testQuadratic23(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.quadTo(1, 0, 0, 1);
    path.lineTo(0, 1);
...
static void testQuadratic24(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.quadTo(1, 0, 0, 1);
    path.lineTo(0, 1);
...
static void testQuadratic25(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.quadTo(1, 0, 1, 1);
    path.lineTo(1, 1);
...
static void testQuadratic26(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.quadTo(1, 0, 1, 1);
    path.lineTo(0, 2);
...
static void testQuadratic27(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.quadTo(1, 0, 1, 1);
    path.lineTo(2, 1);
...
static void testQuadratic28(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.quadTo(1, 0, 0, 1);
    path.lineTo(0, 1);
...
static void testQuadratic29(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.quadTo(1, 0, 2, 1);
    path.lineTo(0, 2);
...
static void testQuadratic30(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.quadTo(1, 0, 1, 2);
    path.lineTo(1, 2);
...
static void testQuadratic31(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.quadTo(1, 0, 1, 2);
    path.lineTo(1, 2);
...
static void testQuadratic32(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.quadTo(1, 0, 2, 3);
    path.lineTo(2, 3);
...
static void testQuadratic33(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.quadTo(2, 0, 0, 1);
    path.lineTo(0, 1);
...
static void testQuadratic34(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.quadTo(2, 0, 0, 1);
    path.lineTo(0, 1);
...
static void testQuadratic35(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.quadTo(0, 1, 1, 1);
    path.lineTo(1, 3);
...
static void testQuadratic36(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.quadTo(2, 1, 2, 3);
    path.lineTo(2, 3);
...
static void testQuadratic37(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.quadTo(0, 2, 1, 2);
    path.lineTo(1, 2);
...
static void testQuadratic38(TestOptions* options) {
    SkPath path;
    path.moveTo(1, 0);
    path.quadTo(0, 1, 1, 1);
    path.lineTo(1, 1);
...
static void testQuadratic51(TestOptions* options) {
    SkPath path;
...
static void testQuadratic53(TestOptions* options) {
    SkPath path;
...
static void testQuadratic55(TestOptions* options) {
    SkPath path;
path.moveTo(303.12088f, 141.299606f);
path.lineTo(330.463562f, 217.659027f);
...
static void testQuadratic56(TestOptions* options) {
    SkPath path;
...
static void testLine80(TestOptions* options) {
    SkPath path;
path.moveTo(4, 0);
path.lineTo(3, 7);
path.lineTo(7, 5);
...
static void testQuadratic58(TestOptions* options) {
    SkPath path;
...
static void testQuadratic59x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.moveTo(0, 0);
    path.quadTo(0, 0, 0, 0);
...
static void testQuadratic59(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0, 0);
    path.quadTo(0, 0, 0, 0);
...
static void testQuadratic63(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.quadTo(0, 0, 0, 0);
    path.lineTo(3, 2);
...
static void testQuadratic64(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.quadTo(0, 0, 0, 0);
    path.lineTo(2, 3);
...
static void testQuadratic65(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.quadTo(0, 0, 0, 0);
    path.lineTo(3, 2);
...
static void testQuadratic67x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.moveTo(0, 0);
    path.quadTo(0, 0, 2, 1);
...
static void testQuadratic68(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.quadTo(1, 0, 0, 1);
    path.lineTo(1, 2);
...
static void testQuadratic69(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.quadTo(0, 0, 0, 1);
    path.lineTo(3, 2);
...
static void testQuadratic70x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.moveTo(0, 0);
    path.quadTo(1, 0, 0, 1);
...
static void testQuadratic71(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.quadTo(1, 0, 1, 1);
    path.lineTo(3, 2);
...
static void testQuadratic72(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.quadTo(1, 0, 1, 2);
    path.lineTo(1, 2);
...
static void testQuadratic73(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.quadTo(1, 0, 0, 3);
    path.lineTo(0, 3);
...
static void testQuadratic74(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.quadTo(1, 0, 1, 3);
    path.lineTo(1, 3);
...
static void testQuadratic75(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.quadTo(1, 0, 1, 3);
    path.lineTo(2, 3);
...
static void testQuadratic76(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.quadTo(0, 0, 0, 0);
    path.lineTo(2, 3);
...
static void testQuadratic77(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.quadTo(1, 0, 1, 1);
    path.lineTo(3, 1);
...
static void testQuadratic78(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.quadTo(1, 0, 1, 2);
    path.lineTo(3, 2);
...
static void testQuadratic79(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.quadTo(1, 0, 1, 2);
    path.lineTo(3, 2);
...
static void testEight1(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.lineTo(2, 2);
    path.lineTo(0, 2);
...
static void testEight2(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.lineTo(2, 0);
    path.lineTo(0, 2);
...
static void testEight3(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.lineTo(0, 2);
    path.lineTo(2, 0);
...
static void testEight4(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.lineTo(2, 2);
    path.lineTo(2, 0);
...
static void testEight5(TestOptions* options) {
    SkPath path;
    path.moveTo(1, 0);
    path.lineTo(1, 2);
    path.lineTo(0, 2);
...
static void testEight6(TestOptions* options) {
    SkPath path;
    path.moveTo(1, 0);
    path.lineTo(2, 0);
    path.lineTo(0, 2);
...
static void testEight7(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.lineTo(0, 1);
    path.lineTo(2, 1);
...
static void testEight8(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.lineTo(2, 2);
    path.lineTo(2, 1);
...
static void testEight9(TestOptions* options) {
    SkPath path;
    path.moveTo(1, 0);
    path.lineTo(1, 2);
    path.lineTo(2, 1);
...
static void testEight10(TestOptions* options) {
    SkPath path;
    path.moveTo(1, 0);
    path.lineTo(0, 1);
    path.lineTo(2, 1);
...
static void testQuadratic80(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.quadTo(1, 0, 2, 3);
    path.lineTo(2, 3);
...
static void testQuadratic81(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.quadTo(2, 0, 1, 1);
    path.lineTo(1, 1);
...
static void testQuadratic82(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.quadTo(2, 0, 1, 1);
    path.lineTo(0, 3);
...
static void testQuadratic83(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.quadTo(0, 0, 2, 0);
    path.lineTo(2, 2);
...
static void testQuadratic84(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.quadTo(2, 0, 1, 1);
    path.lineTo(2, 1);
...
static void testQuadratic85(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.quadTo(3, 0, 1, 1);
    path.lineTo(1, 1);
...
static void testQuadratic86(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.quadTo(0, 1, 1, 1);
    path.lineTo(2, 3);
...
static void testQuadratic87(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.quadTo(2, 1, 0, 2);
    path.lineTo(2, 3);
...
static void testQuadratic88(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.quadTo(2, 1, 0, 2);
    path.lineTo(2, 2);
...
static void testQuadratic89x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.moveTo(0, 0);
    path.quadTo(3, 1, 2, 2);
...
static void testQuadratic90x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.moveTo(0, 0);
    path.quadTo(3, 0, 2, 2);
...
static void testQuadratic91(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.quadTo(3, 2, 2, 3);
    path.lineTo(2, 3);
...
static void testQuadratic92x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.moveTo(1, 0);
    path.quadTo(3, 0, 2, 2);
...
static void testLine82(TestOptions* options) {
    SkPath path;
...
static void testLine82a(TestOptions* options) {
    SkPath path;
...
static void testLine82b(TestOptions* options) {
    SkPath path;
    path.addRect(0, 0, 6, 10, SkPathDirection::kCW);
    path.addRect(2, 2, 4, 4, SkPathDirection::kCW);
...
static void testLine82c(TestOptions* options) {
    SkPath path;
    path.addRect(0, 0, 6, 10, SkPathDirection::kCW);
...
static void testLine82d(TestOptions* options) {
    SkPath path;
    path.addRect(0, 0, 6, 10, SkPathDirection::kCW);
    path.addRect(2, 2, 4, 4, SkPathDirection::kCCW);
    path.addRect(2, 6, 4, 8, SkPathDirection::kCCW);
...
static void testLine82e(TestOptions* options) {
    SkPath path;
...
static void testLine82f(TestOptions* options) {
    SkPath path;
    path.addRect(0, 0, 6, 10, SkPathDirection::kCCW);
    path.addRect(2, 2, 4, 4, SkPathDirection::kCW);
    path.addRect(2, 6, 4, 8, SkPathDirection::kCCW);
...
static void testLine82g(TestOptions* options) {
    SkPath path;
    path.addRect(0, 0, 6, 10, SkPathDirection::kCCW);
    path.addRect(2, 2, 4, 4, SkPathDirection::kCCW);
    path.addRect(2, 6, 4, 8, SkPathDirection::kCW);
...
static void testLine82h(TestOptions* options) {
    SkPath path;
    path.addRect(0, 0, 6, 10, SkPathDirection::kCCW);
    path.addRect(2, 2, 4, 4, SkPathDirection::kCCW);
    path.addRect(2, 6, 4, 8, SkPathDirection::kCCW);
...
static void testLine83(TestOptions* options) {
    SkPath path;
...
static void testLine84(TestOptions* options) {
    SkPath path;
...
static void testLine84x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.addRect(0, 12, 60, 30, SkPathDirection::kCCW);
...
static void testLine85(TestOptions* options) {
    SkPath path;
...
static void testQuadralateral1(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.lineTo(0, 0);
    path.lineTo(0, 0);
...
static void testCubic1(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
...
static void testQuadratic93(TestOptions* options) {
    SkPath path;
    path.moveTo(3, 0);
    path.quadTo(0, 1, 3, 2);
    path.lineTo(0, 3);
...
static void testCubic2(TestOptions* options) {
    SkPath path;
    path.moveTo(0,2);
...
static void testQuad1(TestOptions* options) {
    SkPath path;
    path.moveTo(0,0);
    path.quadTo(0,0, 0,1);
    path.lineTo(1,1);
...
static void testQuadralateral2(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.lineTo(2, 2);
    path.lineTo(0, 3);
...
static void testQuadratic94(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.lineTo(8, 8);
    path.quadTo(8, 4, 4, 4);
...
static void testQuadratic95(TestOptions* options) {
    SkPath path;
    path.moveTo(8, 8);
    path.lineTo(0, 0);
    path.quadTo(4, 0, 4, 4);
...
static void testQuadratic96(TestOptions* options) {
    SkPath path;
    path.moveTo(8, 0);
    path.lineTo(0, 8);
    path.quadTo(0, 4, 4, 4);
...
static void testQuadratic97(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 8);
    path.lineTo(8, 0);
    path.quadTo(4, 0, 4, 4);
...
static void testTriangles1(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.lineTo(1, 0);
    path.lineTo(3, 3);
...
static void testTriangles2(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.lineTo(1, 0);
    path.lineTo(3, 3);
...
static void testAddTCoincident1(TestOptions* options) {
    SkPath path;
    path.moveTo(2, 0);
    path.lineTo(2, 2);
    path.lineTo(1, 1);
...
static void testAddTCoincident2(TestOptions* options) {
    SkPath path;
    path.moveTo(2, 0);
    path.lineTo(2, 2);
    path.lineTo(1, 1);
...
static void testQuad2(TestOptions* options) {
    SkPath path;
    path.moveTo(1, 0);
    path.quadTo(0, 1, 3, 2);
    path.lineTo(2, 3);
...
static void testQuad3(TestOptions* options) {
    SkPath path;
    path.moveTo(1, 0);
    path.quadTo(0, 1, 3, 2);
    path.lineTo(3, 3);
...
static void testQuad4(TestOptions* options) {
    SkPath path;
    path.moveTo(2, 0);
    path.quadTo(0, 1, 1, 1);
    path.lineTo(3, 3);
...
static void testQuad5(TestOptions* options) {
    SkPath path;
    path.moveTo(2, 0);
    path.quadTo(0, 1, 2, 2);
    path.lineTo(1, 3);
...
static void testQuad6(TestOptions* options) {
    SkPath path;
    path.moveTo(2, 0);
    path.quadTo(0, 1, 2, 2);
    path.lineTo(1, 3);
...
static void testQuad7(TestOptions* options) {
    SkPath path;
    path.moveTo(3, 0);
    path.quadTo(0, 1, 1, 1);
    path.lineTo(1, 3);
...
static void testQuadLineIntersect1(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.quadTo(3, 1, 0, 3);
    path.lineTo(2, 3);
...
static void testQuadLineIntersect2(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.quadTo(3, 1, 0, 3);
    path.lineTo(0, 3);
...
static void testQuadLineIntersect3(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.quadTo(3, 1, 0, 3);
    path.lineTo(1, 3);
...
static void skphealth_com76s(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kWinding);
...
static void tooCloseTest(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.lineTo(1, 1);
    path.lineTo(1,-1);
...
static void testRect1s(TestOptions* options) {
    SkPath path;
...
static void testRect2s(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0, 0);
    path.lineTo(60, 0);
...
static void testTriangles3x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.moveTo(1, 0);
    path.quadTo(0, 1, 3, 2);
...
static void testQuad8(TestOptions* options) {
    SkPath path;
    path.moveTo(3, 0);
    path.quadTo(0, 1, 3, 2);
    path.lineTo(0, 3);
...
static void testTriangles4x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.moveTo(0, 0);
    path.quadTo(2, 0, 0, 3);
...
static void testQuad9(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.moveTo(1, 0);
    path.quadTo(0, 1, 3, 2);
...
static void testQuad10(TestOptions* options) {
    SkPath path;
    path.moveTo(1, 0);
    path.quadTo(0, 1, 3, 2);
    path.lineTo(3, 3);
...
static void testQuad11(TestOptions* options) {
    SkPath path;
    path.moveTo(2, 0);
    path.quadTo(0, 1, 1, 2);
    path.lineTo(1, 2);
...
static void testQuad12(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.quadTo(0, 0, 0, 0);
    path.lineTo(0, 1);
...
static void testQuadralateral3(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.moveTo(0, 0);
    path.lineTo(0, 0);
...
static void testDegenerate5(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.lineTo(0, 0);
    path.lineTo(1, 0);
...
static void testQuadralateral4(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.lineTo(0, 0);
    path.lineTo(0, 0);
...
static void testDegenerates1(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.quadTo(0, 0, 1, 1);
    path.lineTo(2, 3);
...
static void testQuad13(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.quadTo(0, 0, 1, 1);
    path.lineTo(2, 3);
...
static void testQuad14(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0, 0);
    path.quadTo(0, 0, 1, 1);
...
static void testQuad15(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.quadTo(0, 0, 1, 1);
    path.lineTo(1, 3);
...
static void testQuads16(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.quadTo(0, 0, 1, 1);
    path.lineTo(3, 2);
...
static void testQuads17(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.quadTo(0, 0, 1, 1);
    path.lineTo(3, 2);
...
static void testQuads18(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.quadTo(0, 0, 1, 1);
    path.lineTo(3, 2);
...
static void testQuads19(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.quadTo(0, 0, 2, 1);
    path.lineTo(1, 2);
...
static void testQuads20(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.quadTo(0, 0, 2, 1);
    path.lineTo(1, 3);
...
static void testQuads21(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.quadTo(0, 0, 1, 1);
    path.lineTo(2, 1);
...
static void testQuads22(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.quadTo(0, 0, 2, 0);
    path.lineTo(1, 1);
...
static void testQuads23(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.quadTo(0, 0, 1, 0);
    path.lineTo(1, 1);
...
static void testQuads24(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.quadTo(0, 0, 0, 1);
    path.lineTo(1, 2);
...
static void testQuads25(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.quadTo(0, 0, 0, 1);
    path.lineTo(2, 1);
...
static void testQuads26(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.quadTo(0, 0, 3, 0);
    path.lineTo(1, 1);
...
static void testQuads27(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.quadTo(0, 0, 2, 0);
    path.lineTo(2, 1);
...
static void testQuads28(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.quadTo(0, 0, 0, 1);
    path.lineTo(2, 2);
...
static void testQuads29(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.quadTo(0, 0, 3, 0);
    path.lineTo(2, 1);
...
static void testQuads30(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
...
static void testQuads31(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.quadTo(0, 0, 2, 1);
    path.lineTo(1, 3);
...
static void testQuads32(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.quadTo(0, 0, 1, 1);
    path.lineTo(1, 2);
...
static void testQuads33(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.quadTo(0, 0, 1, 1);
    path.lineTo(2, 1);
...
static void testQuads34(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.quadTo(0, 0, 1, 0);
    path.lineTo(2, 1);
...
static void testQuads35(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.quadTo(0, 0, 1, 0);
    path.lineTo(1, 2);
...
static void testQuads36(TestOptions* options) {
    SkPath path;
    path.moveTo(1, 0);
    path.quadTo(2, 0, 1, 2);
    path.lineTo(2, 2);
...
static void testQuads37(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.moveTo(1, 0);
    path.quadTo(2, 0, 1, 2);
...
static void testQuads38(TestOptions* options) {
    SkPath path;
    path.moveTo(1, 0);
    path.quadTo(3, 0, 0, 2);
    path.lineTo(3, 2);
...
static void testQuads39(TestOptions* options) {
    SkPath path;
    path.moveTo(1, 0);
    path.quadTo(3, 0, 0, 3);
    path.lineTo(0, 3);
...
static void testQuads40(TestOptions* options) {
    SkPath path;
    path.moveTo(1, 0);
    path.quadTo(3, 0, 3, 3);
    path.lineTo(3, 3);
...
static void testQuads41(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.quadTo(0, 0, 1, 0);
    path.lineTo(2, 1);
...
static void testQuads54(TestOptions* options) {
    SkPath path;
    path.moveTo(1, 0);
    path.quadTo(2, 0, 1, 1);
    path.lineTo(3, 1);
...
static void testQuads53(TestOptions* options) {
    SkPath path;
    path.moveTo(1, 0);
    path.quadTo(2, 0, 1, 1);
    path.lineTo(3, 1);
...
static void testQuads52(TestOptions* options) {
    SkPath path;
    path.moveTo(1, 0);
    path.quadTo(2, 0, 1, 1);
    path.lineTo(3, 1);
...
static void testQuads51(TestOptions* options) {
    SkPath path;
    path.moveTo(2, 0);
    path.quadTo(3, 0, 2, 1);
    path.lineTo(3, 2);
...
static void testQuads50(TestOptions* options) {
    SkPath path;
    path.moveTo(2, 0);
    path.quadTo(3, 0, 2, 1);
    path.lineTo(3, 2);
...
static void testQuads49(TestOptions* options) {
    SkPath path;
    path.moveTo(2, 0);
    path.quadTo(3, 0, 2, 1);
    path.lineTo(3, 2);
...
static void testQuads48(TestOptions* options) {
    SkPath path;
    path.moveTo(2, 0);
    path.quadTo(3, 0, 2, 1);
    path.lineTo(3, 2);
...
static void testQuads47(TestOptions* options) {
    SkPath path;
    path.moveTo(2, 0);
    path.quadTo(3, 0, 2, 1);
    path.lineTo(3, 2);
...
static void testQuads46x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.moveTo(2, 0);
    path.quadTo(0, 1, 3, 2);
...
static void testQuads45(TestOptions* options) {
    SkPath path;
    path.moveTo(2, 0);
    path.quadTo(3, 2, 3, 3);
    path.lineTo(3, 3);
...
static void testQuads44(TestOptions* options) {
    SkPath path;
    path.moveTo(2, 0);
    path.quadTo(3, 2, 3, 3);
    path.lineTo(3, 3);
...
static void testQuads43(TestOptions* options) {
    SkPath path;
    path.moveTo(2, 0);
    path.quadTo(2, 3, 3, 3);
    path.lineTo(3, 3);
...
static void testQuads42(TestOptions* options) {
    SkPath path;
    path.moveTo(2, 0);
    path.quadTo(3, 2, 3, 3);
    path.lineTo(3, 3);
...
static void testQuads56(TestOptions* options) {
    SkPath path;
    path.moveTo(2, 0);
    path.quadTo(3, 1, 0, 2);
    path.lineTo(3, 2);
...
static void testQuads57(TestOptions* options) {
    SkPath path;
    path.moveTo(1, 0);
    path.quadTo(3, 0, 3, 1);
    path.lineTo(2, 2);
...
static void testQuads58(TestOptions* options) {
    SkPath path;
    path.moveTo(1, 0);
    path.quadTo(3, 0, 3, 1);
    path.lineTo(1, 3);
...
static void testQuads59(TestOptions* options) {
    SkPath path;
    path.moveTo(3, 0);
    path.quadTo(3, 1, 3, 1);
    path.lineTo(2, 2);
...
static void testQuads60(TestOptions* options) {
    SkPath path;
    path.moveTo(2, 1);
    path.quadTo(0, 2, 3, 2);
    path.lineTo(2, 3);
...
static void testQuads61(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.moveTo(0, 0);
    path.quadTo(0, 0, 2, 0);
...
static void testQuadralateral10(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kWinding);
    path.moveTo(0, 0);
    path.lineTo(0, 0);
...
static void testRect3(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path.addRect(0, 0, 60, 60, SkPathDirection::kCCW);
...
static void testRect4(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
...
static void testQuads62(TestOptions* options) {
    SkPath path;
    path.moveTo(3, 2);
    path.quadTo(1, 3, 3, 3);
    path.lineTo(3, 3);
...
static void testQuads63(TestOptions* options) {
    SkPath path;
    path.moveTo(3, 0);
    path.quadTo(0, 1, 1, 2);
    path.lineTo(3, 3);
...
static void testQuads64(TestOptions* options) {
    SkPath path;
    path.moveTo(3, 0);
    path.quadTo(0, 1, 1, 2);
    path.lineTo(2, 2);
...
static void testTriangle1(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.lineTo(1, 0);
    path.lineTo(2, 3);
...
static void testTriangle2(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.lineTo(1, 0);
    path.lineTo(0, 1);
...
static void testArc(TestOptions* options) {
...
static void testIssue3838(TestOptions* options) {
    SkPath path;
    path.moveTo(220, 170);
    path.lineTo(200, 170);
    path.lineTo(200, 190);
...
static void testIssue3838_3(TestOptions* options) {
    SkPath path;
    path.moveTo(40, 10);
    path.lineTo(60, 10);
    path.lineTo(60, 30);
...
static void testQuads65(TestOptions* options) {
    SkPath path;
    path.moveTo(1, 2);
    path.quadTo(3, 2, 0, 3);
    path.lineTo(1, 3);
...
static void fuzz864a(TestOptions* options) {
    SkPath path;
    path.moveTo(10, 90);
    path.lineTo(10, 90);
    path.lineTo(10, 30);
...
static void cr514118(TestOptions* options) {
    SkPath path;
...
static void fuzz994s_11(TestOptions* options) {
    SkPath path;
...
static void fuzz994s_3414(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 0);
path.moveTo(SkBits2Float(0x42c80000), SkBits2Float(0x42480000));  // 100, 50
path.conicTo(SkBits2Float(0x42c80000), SkBits2Float(0x00000000), SkBits2Float(0x42480000), SkBits2Float(0x00000000), SkBits2Float(0x3f3504f3));  // 100, 0, 50, 0, 0.707107f
...
static void fuzz_twister(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 0);
path.moveTo(0, 600);
...
path.lineTo(123, 600);
path.close();
    options->ignoreRaster = true;  // computes '200' raster error but looks fine
    options->testOne(path);
}

static void fuzz_twister2(TestOptions* options) {
    SkPath path;
...
static void fuzz763_4713_b(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 0);
...
static void dean4(TestOptions* options) {
  SkPath path;
...
static void testQuads66(TestOptions* options) {
    SkPath path;
    path.moveTo(2, 0);
    path.quadTo(3, 1, 2, 2);
    path.lineTo(2, 3);
...
static void testQuads67(TestOptions* options) {
    SkPath path;
    path.moveTo(3, 2);
    path.quadTo(1, 3, 3, 3);
    path.lineTo(3, 3);
...
static void testQuads68(TestOptions* options) {
    SkPath path;
    path.moveTo(1, 2);
    path.quadTo(0, 3, 2, 3);
    path.lineTo(2, 3);
...
static void testQuads69(TestOptions* options) {
    SkPath path;
    path.moveTo(1, 0);
    path.quadTo(2, 2, 2, 3);
    path.lineTo(2, 3);
...
static void testQuads70(TestOptions* options) {
    SkPath path;
    path.moveTo(1, 1);
    path.quadTo(2, 3, 3, 3);
    path.lineTo(3, 3);
...
static void testQuads71(TestOptions* options) {
    SkPath path;
    path.moveTo(1, 1);
    path.quadTo(2, 3, 3, 3);
    path.lineTo(3, 3);
...
static void testQuads72(TestOptions* options) {
    SkPath path;
    path.moveTo(1, 1);
    path.quadTo(2, 3, 3, 3);
    path.lineTo(3, 3);
...
static void testQuads73(TestOptions* options) {
    SkPath path;
    path.moveTo(0, 0);
    path.quadTo(0, 1, 1, 2);
    path.lineTo(0, 3);
...
static void bug5169(TestOptions* options) {
    SkPath path;
...
static void tiger8_393(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 0);
...
static void carsvg_1(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 0);
...
static void simplifyTest_1(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 0);
...
static void joel_1(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 0);
...
static void joel_2(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 0);
...
static void joel_3(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 0);
...
static void joel_4(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 0);
...
static void joel_5(TestOptions* options) {
    SkPath path;
    path.setFillType((SkPathFillType) 0);
...
static void joel_6(TestOptions* options) {
    SkPath path;
...
static void joel_7(TestOptions* options) {
    SkPath path;
...
static void joel_8(TestOptions* options) {
    SkPath path;
...
static void joel_9(TestOptions* options) {
...
static void joel_10(TestOptions* options) {
#if DEBUG_UNDER_DEVELOPMENT
// fails with image mismatch
    SkPath path;
...
static void joel_11(TestOptions* options) {
#if DEBUG_UNDER_DEVELOPMENT
// fails with image mismatch
    SkPath path;
...
static void joel_12(TestOptions* options) {
    SkPath path;
    make_joel_12(path);
    options->testOne(path);
}

static void joel_12x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    make_joel_12(path);
    options->testOne(path);
...
static void joel_13(TestOptions* options) {
    SkPath path;
    make_joel_13(path);
    options->testOne(path);
}
...
static void joel_13x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    make_joel_13(path);
    options->testOne(path);
...
static void joel_14(TestOptions* options) {
    SkPath path;
    make_joel_14(path);
options->testOne(path);
}

static void joel_14x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    make_joel_14(path);
options->testOne(path);
...
static void joel_15(TestOptions* options) {
    SkPath path;
    make_joel_15(path);
options->testOne(path);
}

static void joel_15x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    make_joel_15(path);
options->testOne(path);
...
static void joel_16(TestOptions* options) {
    SkPath path;
    make_joel_16(path);
options->testOne(path);
}

static void joel_16x(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    make_joel_16(path);
options->testOne(path);
...
static void coincubics(TestOptions* options) {
    SkPath path;
...
static void grshapearc(TestOptions* options) {
    SkPath path;
path.setFillType(SkPathFillType::kWinding);
...
static void bug8249(TestOptions* options) {
SkPath path;
path.setFillType(SkPathFillType::kWinding);
...
static void bug8290(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
...
static void bug11958_a(TestOptions* options) {
    SkPath path;
    path.setFillType(SkPathFillType::kWinding);
...
static void bug11958_b(TestOptions* options) {
    SkPath path;
...
static void bug11958_c(TestOptions* options) {
    SkPath path;
...
void V0Simplify(TestOptions* options) {
    static std::vector<TestFunc> tests = {
        TEST_FUNC(bug8290),
        TEST_FUNC(bug8249),
        TEST_FUNC(bug11958_a),
        TEST_FUNC(bug11958_b),
        TEST_FUNC(bug11958_c),
        TEST_FUNC(grshapearc),
        TEST_FUNC(coincubics),
        TEST_FUNC(joel_16x),
        TEST_FUNC(joel_16),
        TEST_FUNC(joel_15x),
        TEST_FUNC(joel_15),
        ...
        TEST_FUNC(joel_2),
        TEST_FUNC(joel_1),
        TEST_FUNC(simplifyTest_1),
        TEST_FUNC(carsvg_1),
        TEST_FUNC(tiger8_393),
        TEST_FUNC(bug5169),
        TEST_FUNC(testQuads73),
        TEST_FUNC(testQuads72),
        TEST_FUNC(testQuads71),
        TEST_FUNC(testQuads70),
        TEST_FUNC(testQuads69),
        TEST_FUNC(testQuads68),
        TEST_FUNC(testQuads67),
        TEST_FUNC(testQuads66),
        TEST_FUNC(dean4),
        TEST_FUNC(fuzz763_4713_b),
        TEST_FUNC(fuzz_twister2),
        TEST_FUNC(fuzz_twister),
        TEST_FUNC(fuzz994s_3414),
        TEST_FUNC(fuzz994s_11),
        TEST_FUNC(cr514118),
        TEST_FUNC(fuzz864a),
        TEST_FUNC(testQuads65),
        TEST_FUNC(testIssue3838_3),
        TEST_FUNC(testIssue3838),
        TEST_FUNC(testArc),
        TEST_FUNC(testTriangle2),
        TEST_FUNC(testTriangle1),
        TEST_FUNC(testQuads64),
        TEST_FUNC(testQuads63),
        TEST_FUNC(testQuads62),
        TEST_FUNC(testRect4),
        TEST_FUNC(testRect3),
        TEST_FUNC(testQuadralateral10),
        TEST_FUNC(testQuads61),
        TEST_FUNC(testQuads60),
        TEST_FUNC(testQuads59),
        TEST_FUNC(testQuads58),
        TEST_FUNC(testQuads57),
        TEST_FUNC(testQuads56),
        TEST_FUNC(testQuads54),
        TEST_FUNC(testQuads53),
        TEST_FUNC(testQuads52),
        TEST_FUNC(testQuads51),
        TEST_FUNC(testQuads50),
        TEST_FUNC(testQuads49),
        TEST_FUNC(testQuads48),
        TEST_FUNC(testQuads47),
        TEST_FUNC(testQuads46x),
        TEST_FUNC(testQuads45),
        TEST_FUNC(testQuads44),
        TEST_FUNC(testQuads43),
        TEST_FUNC(testQuads42),
        TEST_FUNC(testQuads41),
        TEST_FUNC(testQuads36),
        TEST_FUNC(testQuads37),
        TEST_FUNC(testQuads38),
        TEST_FUNC(testQuads39),
        TEST_FUNC(testQuads40),
        TEST_FUNC(testQuads16),
        TEST_FUNC(testQuads17),
        TEST_FUNC(testQuads18),
        TEST_FUNC(testQuads19),
        TEST_FUNC(testQuads20),
        TEST_FUNC(testQuads21),
        TEST_FUNC(testQuads22),
        TEST_FUNC(testQuads23),
        TEST_FUNC(testQuads24),
        TEST_FUNC(testQuads25),
        TEST_FUNC(testQuads26),
        TEST_FUNC(testQuads27),
        TEST_FUNC(testQuads28),
        TEST_FUNC(testQuads29),
        TEST_FUNC(testQuads30),
        TEST_FUNC(testQuads31),
        TEST_FUNC(testQuads32),
        TEST_FUNC(testQuads33),
        TEST_FUNC(testQuads34),
        TEST_FUNC(testQuads35),
        TEST_FUNC(testDegenerates1),
        TEST_FUNC(testQuad13),
        TEST_FUNC(testQuad14),
        TEST_FUNC(testQuad15),
        TEST_FUNC(testQuadratic56),
        TEST_FUNC(testQuadralateral4),
        TEST_FUNC(testQuadralateral3),
        TEST_FUNC(testDegenerate5),
        TEST_FUNC(testQuad12),
        TEST_FUNC(testQuadratic51),
        TEST_FUNC(testQuad8),
        TEST_FUNC(testQuad11),
        TEST_FUNC(testQuad10),
        TEST_FUNC(testQuad9),
        TEST_FUNC(testTriangles4x),
        TEST_FUNC(testTriangles3x),
        TEST_FUNC(testRect2s),
        TEST_FUNC(testRect1s),
        TEST_FUNC(tooCloseTest),
        TEST_FUNC(skphealth_com76s),
        TEST_FUNC(testQuadLineIntersect1),
        TEST_FUNC(testQuadLineIntersect2),
        TEST_FUNC(testQuadLineIntersect3),
        TEST_FUNC(testQuad7),
        TEST_FUNC(testQuad6),
        TEST_FUNC(testQuad5),
        TEST_FUNC(testQuad4),
        TEST_FUNC(testQuad3),
        TEST_FUNC(testQuad2),
        TEST_FUNC(testAddTCoincident2),
        TEST_FUNC(testAddTCoincident1),
        TEST_FUNC(testTriangles2),
        TEST_FUNC(testTriangles1),
        TEST_FUNC(testQuadratic97),
        TEST_FUNC(testQuadratic96),
        TEST_FUNC(testQuadratic95),
        TEST_FUNC(testQuadratic94),
        TEST_FUNC(testQuadralateral2),
        TEST_FUNC(testQuad1),
        TEST_FUNC(testCubic2),
        TEST_FUNC(testCubic1),
        TEST_FUNC(testQuadralateral1),
        TEST_FUNC(testLine85),
        TEST_FUNC(testLine84),
        TEST_FUNC(testLine84x),
        TEST_FUNC(testLine83),
        TEST_FUNC(testLine82h),
        TEST_FUNC(testLine82g),
        TEST_FUNC(testLine82f),
        TEST_FUNC(testLine82e),
        TEST_FUNC(testLine82d),
        TEST_FUNC(testLine82c),
        TEST_FUNC(testLine82b),
        TEST_FUNC(testLine82a),
        TEST_FUNC(testLine82),
        TEST_FUNC(testQuadratic93),
        TEST_FUNC(testQuadratic92x),
        TEST_FUNC(testQuadratic91),
        TEST_FUNC(testQuadratic90x),
        TEST_FUNC(testQuadratic89x),
        TEST_FUNC(testQuadratic88),
        TEST_FUNC(testQuadratic87),
        TEST_FUNC(testQuadratic86),
        TEST_FUNC(testQuadratic85),
        TEST_FUNC(testQuadratic84),
        TEST_FUNC(testQuadratic83),
        TEST_FUNC(testQuadratic82),
        TEST_FUNC(testQuadratic81),
        TEST_FUNC(testQuadratic80),
        TEST_FUNC(testEight1),
        TEST_FUNC(testEight2),
        TEST_FUNC(testEight3),
        TEST_FUNC(testEight4),
        TEST_FUNC(testEight5),
        TEST_FUNC(testEight6),
        TEST_FUNC(testEight7),
        TEST_FUNC(testEight8),
        TEST_FUNC(testEight9),
        TEST_FUNC(testEight10),
        TEST_FUNC(testQuadratic79),
        TEST_FUNC(testQuadratic78),
        TEST_FUNC(testQuadratic77),
        TEST_FUNC(testQuadratic76),
        TEST_FUNC(testQuadratic75),
        TEST_FUNC(testQuadratic74),
        TEST_FUNC(testQuadratic73),
        TEST_FUNC(testQuadratic72),
        TEST_FUNC(testQuadratic71),
        TEST_FUNC(testQuadratic70x),
        TEST_FUNC(testQuadratic69),
        TEST_FUNC(testQuadratic68),
        TEST_FUNC(testQuadratic67x),
        TEST_FUNC(testQuadratic65),
        TEST_FUNC(testQuadratic64),
        TEST_FUNC(testQuadratic63),
        TEST_FUNC(testLine1a),
        TEST_FUNC(testQuadratic59),
        TEST_FUNC(testQuadratic59x),
        TEST_FUNC(testQuadratic58),
        TEST_FUNC(testQuadratic55),
        TEST_FUNC(testQuadratic53),
        TEST_FUNC(testQuadratic38),
        TEST_FUNC(testQuadratic37),
        TEST_FUNC(testQuadratic36),
        TEST_FUNC(testQuadratic35),
        TEST_FUNC(testQuadratic34),
        TEST_FUNC(testQuadratic33),
        TEST_FUNC(testQuadratic32),
        TEST_FUNC(testQuadratic31),
        TEST_FUNC(testQuadratic30),
        TEST_FUNC(testQuadratic29),
        TEST_FUNC(testQuadratic28),
        TEST_FUNC(testQuadratic27),
        TEST_FUNC(testQuadratic26),
        TEST_FUNC(testQuadratic25),
        TEST_FUNC(testQuadratic24),
        TEST_FUNC(testQuadratic23),
        TEST_FUNC(testQuadratic22),
        TEST_FUNC(testQuadratic21),
        TEST_FUNC(testQuadratic20),
        TEST_FUNC(testQuadratic19),
        TEST_FUNC(testQuadratic18),
        TEST_FUNC(testQuadratic17x),
        TEST_FUNC(testQuadratic15),
        TEST_FUNC(testQuadratic14),
        TEST_FUNC(testQuadratic9),
        TEST_FUNC(testQuadratic8),
        TEST_FUNC(testQuadratic7),
        TEST_FUNC(testQuadratic6),
        TEST_FUNC(testQuadratic5),
        TEST_FUNC(testQuadratic4x),
        TEST_FUNC(testQuadratic3x),
        TEST_FUNC(testQuadratic2x),
        TEST_FUNC(testQuadratic1x),
        TEST_FUNC(testQuadratic4),
        TEST_FUNC(testQuadratic3),
        TEST_FUNC(testQuadratic2),
        TEST_FUNC(testQuadratic1),
        TEST_FUNC(testLine4ax),
        TEST_FUNC(testLine3aax),
        TEST_FUNC(testLine2ax),
        TEST_FUNC(testLine1ax),
        TEST_FUNC(testQuadralateral9x),
        TEST_FUNC(testQuadralateral8x),
        TEST_FUNC(testQuadralateral7x),
        TEST_FUNC(testQuadralateral6x),
        TEST_FUNC(testQuadralateral6ax),
        TEST_FUNC(testQuadralateral9),
        TEST_FUNC(testQuadralateral8),
        TEST_FUNC(testQuadralateral7),
        TEST_FUNC(testQuadralateral6),
        TEST_FUNC(testQuadralateral6a),
        TEST_FUNC(testFauxQuadralateral6dx),
        TEST_FUNC(testFauxQuadralateral6cx),
        TEST_FUNC(testFauxQuadralateral6bx),
        TEST_FUNC(testFauxQuadralateral6ax),
        TEST_FUNC(testFauxQuadralateral6x),
        TEST_FUNC(testFauxQuadralateral6d),
        TEST_FUNC(testFauxQuadralateral6c),
        TEST_FUNC(testFauxQuadralateral6b),
        TEST_FUNC(testFauxQuadralateral6a),
        TEST_FUNC(testFauxQuadralateral6),
        TEST_FUNC(testQuadralateral5x),
        TEST_FUNC(testQuadralateral5),
        TEST_FUNC(testNondegenerate4x),
        TEST_FUNC(testNondegenerate3x),
        TEST_FUNC(testNondegenerate2x),
        TEST_FUNC(testNondegenerate1x),
        TEST_FUNC(testNondegenerate4),
        TEST_FUNC(testNondegenerate3),
        TEST_FUNC(testNondegenerate2),
        TEST_FUNC(testNondegenerate1),
        TEST_FUNC(testDegenerate4x),
        TEST_FUNC(testDegenerate3x),
        TEST_FUNC(testDegenerate2x),
        TEST_FUNC(testDegenerate1x),
        TEST_FUNC(testDegenerate4),
        TEST_FUNC(testDegenerate3),
        TEST_FUNC(testDegenerate2),
        TEST_FUNC(testDegenerate1),
        TEST_FUNC(testLine79x),
        TEST_FUNC(testLine78x),
        TEST_FUNC(testLine77x),
        TEST_FUNC(testLine76x),
        TEST_FUNC(testLine75x),
        TEST_FUNC(testLine74x),
        TEST_FUNC(testLine73x),
        TEST_FUNC(testLine72x),
        TEST_FUNC(testLine71x),
        TEST_FUNC(testLine70x),
        TEST_FUNC(testLine69x),
        TEST_FUNC(testLine68hx),
        TEST_FUNC(testLine68gx),
        TEST_FUNC(testLine68fx),
        TEST_FUNC(testLine68ex),
        TEST_FUNC(testLine68dx),
        TEST_FUNC(testLine68cx),
        TEST_FUNC(testLine68bx),
        TEST_FUNC(testLine68ax),
        TEST_FUNC(testLine67x),
        TEST_FUNC(testLine66x),
        TEST_FUNC(testLine65x),
        TEST_FUNC(testLine64x),
        TEST_FUNC(testLine63x),
        TEST_FUNC(testLine62x),
        TEST_FUNC(testLine61x),
        TEST_FUNC(testLine60x),
        TEST_FUNC(testLine59x),
        TEST_FUNC(testLine58x),
        TEST_FUNC(testLine57x),
        TEST_FUNC(testLine56x),
        TEST_FUNC(testLine55x),
        TEST_FUNC(testLine54x),
        TEST_FUNC(testLine53x),
        TEST_FUNC(testLine52x),
        TEST_FUNC(testLine51x),
        TEST_FUNC(testLine50x),
        TEST_FUNC(testLine49x),
        TEST_FUNC(testLine48x),
        TEST_FUNC(testLine47x),
        TEST_FUNC(testLine46x),
        TEST_FUNC(testLine45x),
        TEST_FUNC(testLine44x),
        TEST_FUNC(testLine43x),
        TEST_FUNC(testLine42x),
        TEST_FUNC(testLine41x),
        TEST_FUNC(testLine40x),
        TEST_FUNC(testLine38x),
        TEST_FUNC(testLine37x),
        TEST_FUNC(testLine36x),
        TEST_FUNC(testLine35x),
        TEST_FUNC(testLine34x),
        TEST_FUNC(testLine33x),
        TEST_FUNC(testLine32x),
        TEST_FUNC(testLine31x),
        TEST_FUNC(testLine30x),
        TEST_FUNC(testLine29x),
        TEST_FUNC(testLine28x),
        TEST_FUNC(testLine27x),
        TEST_FUNC(testLine26x),
        TEST_FUNC(testLine25x),
        TEST_FUNC(testLine24ax),
        TEST_FUNC(testLine24x),
        TEST_FUNC(testLine23x),
        TEST_FUNC(testLine22x),
        TEST_FUNC(testLine21x),
        TEST_FUNC(testLine20x),
        TEST_FUNC(testLine19x),
        TEST_FUNC(testLine18x),
        TEST_FUNC(testLine17x),
        TEST_FUNC(testLine16x),
        TEST_FUNC(testLine15x),
        TEST_FUNC(testLine14x),
        TEST_FUNC(testLine13x),
        TEST_FUNC(testLine12x),
        TEST_FUNC(testLine11x),
        TEST_FUNC(testLine10ax),
        TEST_FUNC(testLine10x),
        TEST_FUNC(testLine9x),
        TEST_FUNC(testLine8x),
        TEST_FUNC(testLine7bx),
        TEST_FUNC(testLine7ax),
        TEST_FUNC(testLine7x),
        TEST_FUNC(testLine6x),
        TEST_FUNC(testLine5x),
        TEST_FUNC(testLine4x),
        TEST_FUNC(testLine3bx),
        TEST_FUNC(testLine3ax),
        TEST_FUNC(testLine3x),
        TEST_FUNC(testLine2x),
        TEST_FUNC(testLine1x),
        TEST_FUNC(testLine81),
        TEST_FUNC(testLine80),
        TEST_FUNC(testLine79),
        TEST_FUNC(testLine78),
        TEST_FUNC(testLine77),
        TEST_FUNC(testLine76),
        TEST_FUNC(testLine75),
        TEST_FUNC(testLine74),
        TEST_FUNC(testLine73),
        TEST_FUNC(testLine72),
        TEST_FUNC(testLine71),
        TEST_FUNC(testLine70),
        TEST_FUNC(testLine69),
        TEST_FUNC(testLine68h),
        TEST_FUNC(testLine68g),
        TEST_FUNC(testLine68f),
        TEST_FUNC(testLine68e),
        TEST_FUNC(testLine68d),
        TEST_FUNC(testLine68c),
        TEST_FUNC(testLine68b),
        TEST_FUNC(testLine68a),
        TEST_FUNC(testLine67),
        TEST_FUNC(testLine66),
        TEST_FUNC(testLine65),
        TEST_FUNC(testLine64),
        TEST_FUNC(testLine63),
        TEST_FUNC(testLine62),
        TEST_FUNC(testLine61),
        TEST_FUNC(testLine60),
        TEST_FUNC(testLine59),
        TEST_FUNC(testLine58),
        TEST_FUNC(testLine57),
        TEST_FUNC(testLine56),
        TEST_FUNC(testLine55),
        TEST_FUNC(testLine54),
        TEST_FUNC(testLine53),
        TEST_FUNC(testLine52),
        TEST_FUNC(testLine51),
        TEST_FUNC(testLine50),
        TEST_FUNC(testLine49),
        TEST_FUNC(testLine48),
        TEST_FUNC(testLine47),
        TEST_FUNC(testLine46),
        TEST_FUNC(testLine45),
        TEST_FUNC(testLine44),
        TEST_FUNC(testLine43),
        TEST_FUNC(testLine42),
        TEST_FUNC(testLine41),
        TEST_FUNC(testLine40),
        TEST_FUNC(testLine38),
        TEST_FUNC(testLine37),
        TEST_FUNC(testLine36),
        TEST_FUNC(testLine35),
        TEST_FUNC(testLine34),
        TEST_FUNC(testLine33),
        TEST_FUNC(testLine32),
        TEST_FUNC(testLine31),
        TEST_FUNC(testLine30),
        TEST_FUNC(testLine29),
        TEST_FUNC(testLine28),
        TEST_FUNC(testLine27),
        TEST_FUNC(testLine26),
        TEST_FUNC(testLine25),
        TEST_FUNC(testLine24a),
        TEST_FUNC(testLine24),
        TEST_FUNC(testLine23),
        TEST_FUNC(testLine22),
        TEST_FUNC(testLine21),
        TEST_FUNC(testLine20),
        TEST_FUNC(testLine19),
        TEST_FUNC(testLine18),
        TEST_FUNC(testLine17),
        TEST_FUNC(testLine16),
        TEST_FUNC(testLine15),
        TEST_FUNC(testLine14),
        TEST_FUNC(testLine13),
        TEST_FUNC(testLine12),
        TEST_FUNC(testLine11),
        TEST_FUNC(testLine10a),
        TEST_FUNC(testLine10),
        TEST_FUNC(testLine9),
        TEST_FUNC(testLine8),
        TEST_FUNC(testLine7b),
        TEST_FUNC(testLine7a),
        TEST_FUNC(testLine7),
        TEST_FUNC(testLine6),
        TEST_FUNC(testLine5),
        TEST_FUNC(testLine4),
        TEST_FUNC(testLine3b),
        TEST_FUNC(testLine3a),
        TEST_FUNC(testLine3),
        TEST_FUNC(testLine2),
        TEST_FUNC(testLine1),
    };
