...
#define TEST_PATH_OP_FIRST "testQuadralaterals3759853"  // e.g., "cubic140721" (ignored by fast test)
#define TEST_PATH_OP_SKIP_TO_V0 1 // if 1 & not fast test, ignore skip to file; run first "v0" test
#define TEST_PATH_OP_SKIP_TO_FILE "quadralateral" // e.g., "quad" tests only (see testSuites in OpSkiaTests)
